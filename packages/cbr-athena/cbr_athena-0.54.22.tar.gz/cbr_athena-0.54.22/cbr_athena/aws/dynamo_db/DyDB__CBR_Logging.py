...
DYNAMO_DB__TABLE_NAME__CBR_LOGGING = 'arn:aws:dynamodb:eu-west-2:470426667096:table/{env}__cbr_logging'         # todo: refactor so that the region_name and account_id are not hardcoded
