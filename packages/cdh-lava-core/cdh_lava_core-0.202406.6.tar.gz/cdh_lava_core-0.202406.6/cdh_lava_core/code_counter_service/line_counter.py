...
class LineCounter:
    ...
    def generate_report(self, print_details=False):
        ...
        self.report_lines.append("| Language | Code | Comment | Blank | Total |")
        self.report_lines.append("| --- | --- | --- | --- | --- |")
        for language, counts in sorted(overall_by_type.items()):
            self.report_lines.append(f"| {language} | {counts[0]:,} | {counts[1]:,} | {counts[2]:,} | {counts[3]:,} |")
