...
from knowledge_mapping.processors.types import SAM_TYPE, DETECTOR_TYPE
from knowledge_mapping.processors.sam import SAM
from knowledge_mapping.processors.detector import Detector
