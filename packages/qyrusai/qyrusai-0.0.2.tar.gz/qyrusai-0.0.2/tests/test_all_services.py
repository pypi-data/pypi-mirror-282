...
def test_create_scenarios_from_jira():
    ...
    jira_api_token = "ATATT3xFfGF0U3mgdNvaOMfAY5sDXJiMSH27zienRoC7g-bF5hBZ46-PMUekiavNvUwZTl5vtSafnPwMf_FPcy2wPIgJxzARQd-3BsIK06U3DtoHYcao0fNolwu4_FoAtuZDjvZof2GBSVW8yDkCe82-IOnoLIG6RzI64ihFfVphnlLwJgFg-zY=FE3A794F"
    jira_ticket_id = "MON-5"
    operation = client.nova.from_jira.create(jira_endpoint, jira_api_token,
...
async def test_create_scenarios_from_image():
    api_token = "1acf91cc-7c9b-4f99-9ce1-0fa3d0fb854d"
    client = AsyncQyrusAI(api_key=api_token)
    image_url = "https://s3-us-west-2.amazonaws.com/ctc-qa-ai/ai/demo/public/images/home-loan-screenshot.png"
