...
from clerk_dev.types import BaseModel, Nullable, UNSET
...
class SamlConnectionsSDK(BaseSDK):
    ...
    def create(
        ...
        attribute_mapping: Optional[Union[Nullable[models.CreateSAMLConnectionAttributeMapping], Nullable[models.CreateSAMLConnectionAttributeMappingTypedDict]]] = UNSET,
        idp_certificate: Optional[Nullable[str]] = UNSET,
        idp_entity_id: Optional[Nullable[str]] = UNSET,
        idp_metadata: Optional[Nullable[str]] = UNSET,
        idp_metadata_url: Optional[Nullable[str]] = UNSET,
        idp_sso_url: Optional[Nullable[str]] = UNSET,
        server_url: Optional[str] = None,
    ...
    def update(
        self, *,
        saml_connection_id: str,
        active: Optional[Nullable[bool]] = UNSET,
        allow_idp_initiated: Optional[Nullable[bool]] = UNSET,
        allow_subdomains: Optional[Nullable[bool]] = UNSET,
        attribute_mapping: Optional[Union[Nullable[models.UpdateSAMLConnectionAttributeMapping], Nullable[models.UpdateSAMLConnectionAttributeMappingTypedDict]]] = UNSET,
        domain: Optional[Nullable[str]] = UNSET,
        idp_certificate: Optional[Nullable[str]] = UNSET,
        idp_entity_id: Optional[Nullable[str]] = UNSET,
        idp_metadata: Optional[Nullable[str]] = UNSET,
        idp_metadata_url: Optional[Nullable[str]] = UNSET,
        ...
        sync_user_attributes: Optional[Nullable[bool]] = UNSET,
        server_url: Optional[str] = None,
    ) -> models.SAMLConnection:
