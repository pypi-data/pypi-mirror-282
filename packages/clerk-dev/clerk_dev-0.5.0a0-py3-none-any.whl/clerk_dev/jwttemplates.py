...
class JwtTemplates(BaseSDK):
    ...
    def create(
        self, *,
        allowed_clock_skew: Optional[Nullable[float]] = UNSET,
        ...
        lifetime: Optional[Nullable[float]] = UNSET,
        name: Optional[str] = None,
        signing_algorithm: Optional[Nullable[str]] = UNSET,
        signing_key: Optional[Nullable[str]] = UNSET,
        server_url: Optional[str] = None,
    ) -> models.JWTTemplate:
