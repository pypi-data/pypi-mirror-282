...
class Users(BaseSDK):
    ...
    def create(
        ...
        email_address: Optional[List[str]] = None,
        external_id: Optional[Nullable[str]] = UNSET,
        first_name: Optional[Nullable[str]] = UNSET,
        last_name: Optional[Nullable[str]] = UNSET,
        password: Optional[Nullable[str]] = UNSET,
        ...
        username: Optional[Nullable[str]] = UNSET,
        web3_wallet: Optional[List[str]] = None,
        server_url: Optional[str] = None,
    ) -> models.User:
        r"""Create a new user
    ...
    def update(
        ...
        user_id: str,
        backup_codes: Optional[List[str]] = None,
        create_organization_enabled: Optional[Nullable[bool]] = UNSET,
        created_at: Optional[str] = None,
        delete_self_enabled: Optional[Nullable[bool]] = UNSET,
        external_id: Optional[Nullable[str]] = UNSET,
        first_name: Optional[Nullable[str]] = UNSET,
        last_name: Optional[Nullable[str]] = UNSET,
        ...
        profile_image_id: Optional[Nullable[str]] = UNSET,
        public_metadata: Optional[Union[models.UpdateUserPublicMetadata, models.UpdateUserPublicMetadataTypedDict]] = None,
        sign_out_of_other_sessions: Optional[Nullable[bool]] = UNSET,
        skip_password_checks: Optional[Nullable[bool]] = UNSET,
        totp_secret: Optional[str] = None,
