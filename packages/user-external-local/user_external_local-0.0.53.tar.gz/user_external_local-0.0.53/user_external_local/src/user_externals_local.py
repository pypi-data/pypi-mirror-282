...
class UserExternalsLocal(GenericCRUD, metaclass = MetaLogger):
    ...
    def get_credential_storage_id_by_system_id_and_profile_id(self, *, system_id: str, profile_id: str):
        try:
            credential_storage_id = self.select_one_value_by_where(schema_name=DEFAULT_SCHEMA_NAME,
                                           view_table_name=DEFAULT_VIEW_NAME,
