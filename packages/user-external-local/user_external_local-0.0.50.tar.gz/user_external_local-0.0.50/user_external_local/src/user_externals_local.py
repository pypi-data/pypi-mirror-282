...
class UserExternalsLocal(GenericCRUD):
    ...
    def get_storage_id_by_system_id_and_profile_id(self, *, system_id: str, profile_id: str):
        try:
            storage_id = self.select_one_value_by_where(schema_name=DEFAULT_SCHEMA_NAME,
