...
from cqlib.exceptions import CtqKitRequestError, CtqKitInputParaError
        ...
        def wrapper(self, *args, **kwargs):
            ...
            while retries < max_retries:
                ...
                try:
                    ...
                    return result
                except CtqKitRequestError as ctq_e:
                    last_error = ctq_e
                    logger.warning(
                        f"{func.__name__} execution failed\n"
                        f"try count:{retries} \nerror info: \n{ctq_e}"
                    )
                    if ctq_e.status_code == 401:
                ...
                except Exception as ctq_e:
                    last_error = ctq_e

            if last_error:
                raise last_error
            else:
                raise CtqKitRequestError(
