...
if __name__ == '__main__':
    ...
    output_folder = '/Users/seba/Projects/botrun_ask_folder/data/1zu0BaSmKdOqPrO7Rk74bwyU8mrFyHOtM/中央政府嚴重特殊傳染性肺炎防治及紓困振興特別決算審核報告 06-甲參重要審核意見.docx.txts'
    source_file = '/Users/seba/Projects/botrun_ask_folder/data/1zu0BaSmKdOqPrO7Rk74bwyU8mrFyHOtM/中央政府嚴重特殊傳染性肺炎防治及紓困振興特別決算審核報告 06-甲參重要審核意見.docx'
    stats = {'cached': 0, 'generated': 0}
    chars_per_page = 2000
    force = True
    process_single_file(source_file, output_folder, chars_per_page, force, stats)
