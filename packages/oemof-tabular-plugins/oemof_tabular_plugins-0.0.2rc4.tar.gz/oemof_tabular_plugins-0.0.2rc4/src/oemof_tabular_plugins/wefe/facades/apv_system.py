    ...
    def build_solph_components(self):
        ...
        def apv_geometry(instance):
            ...
            ***** Part 1: Define general geometry parameters and initiate radiance model *****
            ...
            rad_model.setGround(
                material=albedo
            )  # must be run before for .gencumsky or .gendaylit
            rad_model.genCumSky()
            ...
            for step in range(steps):
                ...
                frontscan, backscan = analysis.moduleAnalysis(
                    scene=scene, sensorsy=sensors, sensorsx=sensors
                )
                ...
                analysis.analysis(
                    octfile=oct,
                    name=rad_model.basename + f"_panelscan_{step}",
                    frontscan=frontscan,
                    backscan=backscan,
                )
                ...
                analysis.analysis(
                    octfile=oct,
                    name=rad_model.basename + f"_groundscan_{step}",
                    frontscan=groundfrontscan,
