...
from ytservice import (model, version, ytclient, common, exception_handlers)
...
@app.get("/")
def read_root():
    return dict(app=APP_NAME, version=version.VERSION,
...
def start_server(host, port, proxy, download_dir, signal):
    if signal:
