...
class EPVideo:
    def __init__(self):
        self.base_url = "https://modelslab.com/api/v1/enterprise/video"

    def txt2video(self, key, model_id, prompt, negative_prompt, height, width, num_frames, num_inference_steps, guidance_scale, upscale_height, upscale_width, upscale_strength, upscale_guidance_scale, upscale_num_inference_steps, output_type, webhook=None, track_id=None):
    ...
    def video2video(self, key, model_id, prompt, negative_prompt, init_video, clip_skip, num_inference_steps, use_improved_sampling=False, guidance_scale=9.5, strength=0.8, base64=False, webhook=None, track_id=None):
        url = f"{self.base_url}/video2video"
        payload = json.dumps({
            "key": key,
            "model_id": model_id,
            "prompt": prompt,
    ...
    def scene_creator(self, key, prompts, prompt_durations, animations, negative_prompt, height, width, temp=True):
