...
from blended.customtags.exceptions import TemplateSyntaxWarning
...
class StringValue(object):
    ...
    def resolve(self, context):
        try:
            ...
            # print(b)
            # print(type(b))
            # if type(a) != type(self.var.resolve(context)):
            #     print(type(a))
    ...
    def clean(self, value):
        ...
        NOTE: The above doesn't seem to be entirely true anymore, so we can comment
              out the special casing.
        """
