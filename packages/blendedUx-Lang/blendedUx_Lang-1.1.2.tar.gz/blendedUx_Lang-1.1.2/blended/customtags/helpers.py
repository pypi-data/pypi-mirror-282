...
from blended.customtags.core import Tag
from blended.customtags.arguments import Argument, Constant, NodeList, next_contained_argument
...
class AsTag(Tag):
    ...
    def render_tag(self, context, *args, **kwargs):
        varname = kwargs.pop(self.varname_name, None)
