...
from blended.customtags.templatetags.customtags import register
from blended.customtags.arguments import *
from blended.customtags.core import *
from blended.customtags.utils import process_decorator_args_kwargs
...
def block_decorator(register=register, name=None):
    ...
    def decorator(*args, **kwargs):
        ...
        def callback(context, *args, **kwargs):
            ...
            as_name = kwargs.pop("__as_name__", None)
