...
class ChildServer(ObserverNotifier):
    ...
    async def start(self, *_):
        ...
        shutil.copy(f'{self.directory}/cfg/entry_list.ini', f'{self.directory}/logs/acws/entry_list{timestamp}-{self.child_title}.ini')
        shutil.copy(f'{self.directory}/cfg/server_cfg.ini', f'{self.directory}/logs/acws/server_cfg{timestamp}-{self.child_title}.ini')
