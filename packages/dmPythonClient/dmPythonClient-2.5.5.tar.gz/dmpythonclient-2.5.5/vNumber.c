...
static int Base64Var_SetValue(udt_Base64Var*, unsigned, PyObject*);
static PyObject *Base64Var_GetValue(udt_Base64Var*, unsigned);
static int Base64Var_BindObjectValue(udt_Base64Var*, unsigned, dhobj, udint4);
...
PyTypeObject g_RowIdType = {
    ...
    sizeof(udt_Base64Var),              // tp_basicsize
    0,                                  // tp_itemsize
    0,                                  // tp_dealloc
    0,                                  // tp_print
    0,                                  // tp_getattr
...
int 
Base64Var_SetValue(
    udt_Base64Var*      var,            // variable to set value for
    unsigned            pos,            // array position to set
    PyObject*           value           // value to set
)                    
{   
...
PyObject*
Base64Var_GetValue(
    udt_Base64Var*      var,                // variable to determine value for
    unsigned            pos                 // array position
)
{
    PyObject*           stringObj;
