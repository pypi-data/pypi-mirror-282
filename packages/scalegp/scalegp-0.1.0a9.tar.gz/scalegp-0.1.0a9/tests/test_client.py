...
class TestSGP:
    client = SGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=True)
    ...
    def test_client_timeout_option(self) -> None:
        client = SGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_base_url_setter(self) -> None:
        client = SGP(base_url="https://example.com/from_init", x_api_key=x_api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(SGP_BASE_URL="http://localhost:5000/from/env"):
            client = SGP(x_api_key=x_api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            SGP(base_url="http://localhost:5000/custom/path/", x_api_key=x_api_key, _strict_response_validation=True),
            SGP(
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            SGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = SGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = SGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=False)
...
class TestAsyncSGP:
    client = AsyncSGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(SGP_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncSGP(x_api_key=x_api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncSGP(base_url=base_url, x_api_key=x_api_key, _strict_response_validation=False)
