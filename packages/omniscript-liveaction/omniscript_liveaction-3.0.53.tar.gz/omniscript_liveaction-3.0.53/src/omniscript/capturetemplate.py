...
class AnalysisSettings(object):
    ...
    option_application_analysis = False
    """Is the Application Analysis option enabled?"""
    ...
    _json_application_analysis = 'applicationAnalysis'
    ...
    _tag_application_analysis = 'application_analysis'
    ...
    _tag_xml_application_analysis = "Application Analysis"
    ...
    _analysis_prop_dict = {
        ...
        _json_application_analysis: _tag_application_analysis,
    ...
    def _load(self, props, engine=None):
        ...
        for k, v in props.items():
            ...
            elif a == AnalysisSettings._tag_application_analysis:
                self.option_application_analysis = v
