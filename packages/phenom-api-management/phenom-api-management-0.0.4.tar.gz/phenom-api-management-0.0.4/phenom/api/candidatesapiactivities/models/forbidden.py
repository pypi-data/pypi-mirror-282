...
class Forbidden(object):
    ...
    def status(self):
        ...
        Indicates the status of the error response. It typically represents a 'forbidden' request.  # noqa: E501
    ...
    def error(self):
        ...
        A string representing the type of error. It is set to 'ACCESS_DENIED' to indicate that the request is forbidden.  # noqa: E501
    ...
    def message(self):
        ...
        A human readable message providing additional information about the 'forbidden' error. It informs the user that they are not allowed to access the specified resource.  # noqa: E501
