...
from . import CLIOptions, device_subcommand, user_subcommand
...
app.add_typer(user_subcommand.app)
app.add_typer(user_subcommand.app, name=user_subcommand.__ALIAS__, hidden=True)
