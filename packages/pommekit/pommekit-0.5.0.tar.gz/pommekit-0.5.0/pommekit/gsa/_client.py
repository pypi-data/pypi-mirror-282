...
if TYPE_CHECKING:
    from ..device import MachineDataComponent, ProvidesAnisetteHeaders
...
class GSAClient:
    def __init__(
        self: Self,
        anisette_provider: MachineDataComponent | ProvidesAnisetteHeaders,
    ) -> None:
    ...
    async def _request(self: Self, data: dict[str, ...]) -> dict[str, ...]:
        ...
        headers = self._anisette_provider.anisette_headers
    ...
    async def request_device_2fa(self: Self) -> None:
        ...
        response = await self._client.get(
            ...
            headers=self._anisette_provider.anisette_headers | self._extra_headers,
        )
    ...
    async def validate_device_2fa(self: Self, security_code: str) -> bool:
        ...
        anisette_headers = self._anisette_provider.anisette_headers
