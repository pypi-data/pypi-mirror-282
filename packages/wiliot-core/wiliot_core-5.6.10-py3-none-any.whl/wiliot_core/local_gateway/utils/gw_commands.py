...
class CommandDetails(Enum):
    ...
    reset = {'cmd': 'reset', 'cmd_shortcut': 'r', 'num_of_args': ['0'], 'status_return': True, 'cmd_func': 'cmd_reset'}
    move_to_bootloader = {'cmd': 'move_to_bootloader', 'cmd_shortcut': 'mtb', 'num_of_args': ['0'], 'status_return': True, 'cmd_func': 'cmd_move_to_bootloader'}
    ...
    send_rssi_config = {'cmd': 'send_rssi_config', 'cmd_shortcut': 'NONE', 'num_of_args': ['1'], 'status_return': True, 'cmd_func': 'cmd_send_rssi_config'}
