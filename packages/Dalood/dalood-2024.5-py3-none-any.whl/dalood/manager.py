...
class Manager:
    ...
    def register_loader(
        ...
        Args:
            ...
            pattern_type:
                The pattern type, either as an instance of PatternType or a
                string that is recognized by PatternType.from_str (e.g. "glob",
                "literal").
        """
    ...
    def clear_cache(
        ...
        Args:
            pattern:
                Same as for register_loader. If given, only cached items
                matching this pattern will be cleared.

            pattern_type:
                Same as for register_loader.
    ...
    def refresh(self, pattern=None, pattern_type=PatternType.REGEX):
        ...
        Args:
            pattern:
                Same as for register_loader. If given, only cached items
                matching this pattern will be refreshed.
    ...
    for name, method in inspect.getmembers(Manager, predicate=inspect.isfunction):
        ...
        if "pattern" in params and "pattern_type" in params:
            ...
            for pattern_type in PatternType:
                ...
                new_method.__doc__ = (
                    f"Wrapper around {name} for {pattern_type.name} patterns."
                )
