...
//              ENC_PIN_MODE_DAC        макрос определён выше                                                                           //  setPinOut( Выход в режиме ЦАП                , количество полных оборотов от минимума до максимума [, частота ШИМ в Гц] ).
                                                                                                                                        //
class iarduino_I2C_Encoder: iarduino_I2C {                                                                                                             //
    public:                                                                                                                             //
    /** Конструктор класса **/                                                                                                          //
    ...
    /** Внутренние переменные **/                                                                                                       //
        ...
        iarduino_I2C  i2c;                                                                                                     //  Объявляем  указатель  на  объект полиморфного класса iarduino_I2C_BASE, но в конструкторе данного класса этому указателю будет присвоена ссылка на производный класс iarduino_I2C.
    /** Внутренние функции **/                                                                                                          //
