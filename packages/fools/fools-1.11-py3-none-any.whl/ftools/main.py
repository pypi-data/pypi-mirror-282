...
def start():
    ...
    cprint("Welcome to . (short for funny tools)! This is just a small project by me (walper),", size=size)
...
@click.option("--s", prompt="The size of the text", help="The size of the text")
@click.option("--t", prompt="The text you want to display", help="The text to be added.")

def surround(p, s, t):
    surrounder.add_black_border_with_text(image_path=p, font_size=s, text=t)
