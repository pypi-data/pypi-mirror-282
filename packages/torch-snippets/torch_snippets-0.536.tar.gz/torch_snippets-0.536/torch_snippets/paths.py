...
# %% auto 0
__all__ = ['valid_methods', 'ls', 'print_folder_summary', 'dill', 'input_to_str', 'output_to_path', 'process_f', 'get_fs', 'P',
           'stem', 'stems', 'remove_file', 'isdir', 'makedir', 'fname', 'fname2', 'parent', 'extn', 'Glob', 'find',
           'zip_files', 'unzip_file', 'list_zip', 'md5', 'remove_duplicates', 'common_items', 'folder_summary',
           'readlines', 'writelines', 'tree', 'rename_batch', 'dumpdill', 'loaddill']
...
class P(Path):
    ...
    def __getattr__(self, name):
        if name in valid_methods or self.isfile:
