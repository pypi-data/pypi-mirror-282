...
def landsat8(landsat_toa):
    ...
    properties = {
        ...
        # 'COLLECTION_CATEGORY': landsat_rt.get('COLLECTION_CATEGORY'),
        # 'COLLECTION_NUMBER': landsat_rt.get('COLLECTION_NUMBER'),
        # 'IMAGE_QUALITY_OLI': landsat_rt.get('IMAGE_QUALITY_OLI'),
        # 'IMAGE_QUALITY_TIRS': landsat_rt.get('IMAGE_QUALITY_TIRS'),
        # 'LANDSAT_PRODUCT_ID': landsat_rt.get('LANDSAT_PRODUCT_ID'),
        # 'LANDSAT_SCENE_ID': landsat_rt.get('LANDSAT_SCENE_ID'),
        ...
        # 'SUN_AZIMUTH': landsat_rt.get('SUN_AZIMUTH'),
        # 'SUN_ELEVATION': landsat_rt.get('SUN_ELEVATION'),
