...
logger = setup_logger("process_logger", "app.log")
...
async def fazer_pudim(uuid_processo, nom_processo):
    try:
        num_actions = 10
        actions = []
...
if __name__ == "__main__":
    uuid_processo = sys.argv[1]
    nom_processo = sys.argv[2]
    result = asyncio.run(fazer_pudim(uuid_processo, nom_processo))
    print(result)
