r"""
 _____ ______   ________  _________  ___  ___  ________  ________  ________
...
Math_Pro is a Python library that offers a comprehensive set of mathematical tools for numerical computation,
...
if version != __version__:
    raise RuntimeError("The version {} of PyPyNum does not match the version {} of Math_Pro. "
                       "Please update both packages to the latest version.".format(version, __version__))
print("Math_Pro", "Version -> " + __version__, "It is an alias for PyPyNum",
