...
public final class ChargerData extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_1_12_0(); }
  public static ChargerData getRootAsChargerData(ByteBuffer _bb) { return getRootAsChargerData(_bb, new ChargerData()); }
  public static ChargerData getRootAsChargerData(ByteBuffer _bb, ChargerData obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public ChargerData __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createChargerData(FlatBufferBuilder builder,
      int timestampsOffset,
      int voltageOffset) {
    builder.startTable(2);
    ChargerData.addVoltage(builder, voltageOffset);
    ChargerData.addTimestamps(builder, timestampsOffset);
    return ChargerData.endChargerData(builder);
  }

  public static void startChargerData(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static int endChargerData(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public ChargerData get(int j) { return get(new ChargerData(), j); }
    public ChargerData get(ChargerData obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
