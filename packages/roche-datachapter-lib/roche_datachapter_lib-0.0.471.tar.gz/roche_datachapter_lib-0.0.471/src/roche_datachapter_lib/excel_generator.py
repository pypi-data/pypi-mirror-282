...
class ExcelGenerator:
    ...
    @classmethod
    def generate_excel(cls, query, bind, file_path, worksheet_name):
        """Genera un archivo excel a partir de una query de la base de datos"""
        df = DB_CONFIG.execute_custom_select_query(query, bind, result_set_as= ResultType.PANDAS_DATA_FRAME)
