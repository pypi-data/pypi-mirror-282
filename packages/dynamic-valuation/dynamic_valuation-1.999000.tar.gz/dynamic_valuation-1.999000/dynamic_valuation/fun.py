...
def vf_plot(cl):
  ...
  cl.vax.plot(cl.s_grid, rhs,color='blue',label=r"$\frac{W(s)+V'(s)\dot{s}(s)}{\delta}$")

  cl.vax.scatter(cl.s_grid[value_set==0], v[value_set==0], 'ro',ms=2,label='Approximate Solution',lw=4)
  cl.vax.legend()
