...
def compare2chains(chain_1, chain_2, chain_3, chain_4, burn_in, sample_interval, with_bpcomp, with_tracecomp, op_dir, cmd_txt):
    ...
    if with_bpcomp is True:
        ...
        print('3. 0.3 < maxdiﬀ < 1: the sample is not yet suﬃciently large, and the chains have not converged, but this is on the right track.')
        print('4. if maxdiﬀ = 1 even after 10,000 points, this indicates that at least one of the runs is stuck in a local maximum.')
        print()
