...
from n8n_minus_1.1.1._utils import PropertyInfo
from n8n_minus_1.1.1._compat import PYDANTIC_V2, parse_obj, model_dump, model_json
from n8n_minus_1.1.1._models import BaseModel, construct_type
