...
from n8n_minus_1.1.1._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(sync: bool, client: N8n, async_client: AsyncN8n) -> None:
...
async def test_data_missing_event(
    sync: bool, client: N8n, async_client: AsyncN8n
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"
