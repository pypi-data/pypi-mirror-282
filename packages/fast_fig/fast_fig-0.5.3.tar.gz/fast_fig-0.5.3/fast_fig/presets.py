...
def define_presets(presets: Optional[Union[dict, str, Path]] = None) -> dict:
    ...
    if (isinstance(presets, str) or isinstance(presets, Path)) and Path(presets).is_file():
...
def validate_preset(preset: dict) -> dict:
