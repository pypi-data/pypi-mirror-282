...
from selenium_helper.libs import get_element
from selenium_helper.utils import get_current_ct
...
class SeleniumApi(object):
    ...
    @classmethod
    def parse_flight_data_with_json(cls, data: dict, is_full: bool = True) -> list:
