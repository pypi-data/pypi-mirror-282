...
class EmployeeRoleSchema(BaseModel):
    ...
    sync_employee: Optional[StrictStr] = None
    notification_channels: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["created_on", "updated_on", "id", "name", "description", "company", "tools", "sync_employee", "notification_channels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sync_employee (nullable) is None
        # and model_fields_set contains the field
        if self.sync_employee is None and "sync_employee" in self.model_fields_set:
            _dict['sync_employee'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tools": obj.get("tools"),
            "sync_employee": obj.get("sync_employee"),
