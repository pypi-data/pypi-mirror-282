...
class LimitOffsetPageEmployeeRoleSchema(BaseModel):
    """
    LimitOffsetPageEmployeeRoleSchema
    """ # noqa: E501
    items: List[EmployeeRoleSchema]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [EmployeeRoleSchema.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
