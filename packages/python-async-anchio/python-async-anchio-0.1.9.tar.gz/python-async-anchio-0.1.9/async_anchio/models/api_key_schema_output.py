...
class APIKeySchemaOutput(BaseModel):
    """
    APIKeySchemaOutput
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "key": obj.get("key"),
            "context": APIKeyContextOutput.from_dict(obj.get("context")) if obj.get("context") is not None else None
        })
        return _obj
