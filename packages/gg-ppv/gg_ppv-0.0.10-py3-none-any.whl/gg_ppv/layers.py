...
class PaddedPacketListField(PacketField):
    ...
    def __init__(self, name, default, cls=None, count_from=None, length_per_packet=None):  # noqa: E501
        if default is None:
            ...
            try:
                ...
                if self.length_per_packet is not None:
                    ...
                    if self.next_cls_cb is not None:
                        cls = self.next_cls_cb(pkt, lst, p, pkt_buf)
                        if cls is not None:
...
class ChannelReset(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=9)
...
class AdminHeartbeat(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=0)
...
class AdminLogin(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=1)
...
class AdminLogout(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=180)
...
class MDInstrumentDefinitionFuture(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=216)
...
class MDInstrumentDefinitionSpread(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=195)
...
class SecurityStatus(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=30)
...
class MDIncrementalRefreshBook(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=11)
...
class SnapshotFullRefresh(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=59)
...
class QuoteRequest(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=35)
...
class MDInstrumentDefinitionOption(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=213)
...
class SnapshotFullRefreshOrderBook(Packet):
    ...
    blockPadded = PadField(PacketField('block', default=FixBlock(),cls=FixBlock),align=28)
