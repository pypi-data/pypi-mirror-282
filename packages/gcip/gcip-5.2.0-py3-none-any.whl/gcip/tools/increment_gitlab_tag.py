...
def main(
    ...
    if not token:
        raise ValueError(f"Environment variable {token_env} must be set")
    ...
    for project in projects:
        ...
        project_instance = gl.projects.get(project)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Environment variable for GitLab private token.",
    )
    parser.add_argument(
        "--gitlab-host",
        type=str,
