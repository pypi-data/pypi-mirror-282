...
from trader_tweets_core.model.prompt.stance import stance
...
def parse_stance_response(gpt_response: str) -> TweetStance:
    if 'bull' in gpt_response.lower():
        return TweetStance.BULLISH
    elif 'bear' in gpt_response.lower():
        return TweetStance.BEARISH
    return TweetStance.NEUTRAL
