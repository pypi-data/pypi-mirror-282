...
from trader_tweets_core.model.prompt.mood import Mood
...
def parse_mood_response(gpt_response: str) -> TweetMood:
    if 'bull' in gpt_response.lower():
        return TweetMood.BULLISH
    elif 'bear' in gpt_response.lower():
        return TweetMood.BEARISH
    return TweetMood.NEUTRAL
