...
def make_typer(**kwargs):
    ...
    :param epname: Setuptools entry point name for the command.
    """
...
def typer_eager_imports(
    ...
    """
    Eagerly import all modules which are registered as having commands
...
def make_cli_config(ctx):
    """
    Titeship (custom Rattail system)
    """
    kwargs = ctx.params
