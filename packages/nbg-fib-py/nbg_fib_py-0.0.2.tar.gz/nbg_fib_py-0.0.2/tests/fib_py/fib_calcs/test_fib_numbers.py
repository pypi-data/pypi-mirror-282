...
class Test(TestCase):
    ...
    def test_calculate_numbers(self, mock_fib_calc):
        ...
        self.assertEqual(expected_outcome, calculate_numbers(numbers=[3, 4, 5]))
        self.assertEqual(3, len(mock_fib_calc.call_args_list))
        self.assertEqual({"number": 3}, mock_fib_calc.call_args_list[0][1])
        self.assertEqual({"number": 4}, mock_fib_calc.call_args_list[1][1])
        self.assertEqual({"number": 5}, mock_fib_calc.call_args_list[2][1])
