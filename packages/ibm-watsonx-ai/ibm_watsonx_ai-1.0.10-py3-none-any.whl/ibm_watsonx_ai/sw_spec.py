...
class SwSpec(WMLResource):
    ...
    def get_details(
        ...
        :param sw_spec_id: ID of software specification
        :type sw_spec_id: str, optional

        :param state_info: works only when `sw_spec_id` is None, instead of returning details of software specs returns
    ...
    def list(self, limit: int | None = None) -> DataFrame:
        """Lists software specifications in a table format.
    ...
    def delete(self, sw_spec_id: str | None = None, **kwargs: Any) -> str:
        ...
        :param sw_spec_id: Unique Id of software specification
        :type sw_spec_id: str
    ...
    def add_package_extension(
        ...
        **kwargs: Any,
        ...
        :param sw_spec_id: Unique Id of software specification which should be updated
        :type sw_spec_id: str
