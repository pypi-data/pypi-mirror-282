...
class vtkCollisionDetectionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def IntersectPolygonWithPolygon(self, npts:int, pts:[float, ...], bounds:[float, float, float, float, float, float], npts2:int, pts2:[float, ...], bounds2:[float, float, float, float, float, float], tol2:float, x1:[float, float, float], x2:[float, float, float], CollisionMode:int) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
