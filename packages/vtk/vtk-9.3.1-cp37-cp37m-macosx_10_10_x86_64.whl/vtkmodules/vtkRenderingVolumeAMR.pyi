...
class vtkAMRVolumeMapper(vtkmodules.vtkRenderingVolume.vtkVolumeMapper):
    ...
    @staticmethod
    def ComputeResamplerBoundsFrustumMethod(camera:vtkCamera, renderer:vtkRenderer, data_bounds:(float, float, float, float, float, float), out_bounds:[float, float, float, float, float, float]) -> bool: ...
    ...
    @overload
    def GetCroppingRegionPlanes(self, planes:[float, float, float, float, float, float]) -> None: ...
    @overload
