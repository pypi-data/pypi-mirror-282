...
class vtkAbstractImageInterpolator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetDirection(self) -> (float, float, float, float, float, float, float, float, float): ...
...
class vtkImageBSplineInternals(object):
    @staticmethod
    def ConvertToInterpolationCoefficients(data:[float, ...], size:int, border:vtkImageBorderMode, poles:[float, float, float, float], numPoles:int, tol:float) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def InterpolatedValue(coeffs:(float, ...), value:[float, ...], width:int, height:int, slices:int, depth:int, x:float, y:float, z:float, degree:int, border:vtkImageBorderMode) -> int: ...
...
class vtkImageChangeInformation(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetOutputDirection(self) -> (float, float, float, float, float, float, float, float, float): ...
    ...
    def SetOutputDirection(self, data:(float, ...)) -> None: ...
    @overload
...
class vtkImageReslice(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetOutputDirection(self) -> (float, float, float): ...
    ...
    @overload
    def SetOutputDirection(self, a:(float, float, float, float, float, float, float, float, float)) -> None: ...
