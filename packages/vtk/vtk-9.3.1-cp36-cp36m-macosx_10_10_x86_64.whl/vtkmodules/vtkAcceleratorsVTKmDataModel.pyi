...
class vtkmDataSet(vtkmodules.vtkCommonDataModel.vtkDataSet):
    ...
    @overload
    def FindCell(self, x:[float, float, float], cell:vtkCell, cellId:int, tol2:float, subId:int, pcoords:[float, float, float], weights:[float, ...]) -> int: ...
    @overload
    def FindCell(self, x:[float, float, float], cell:vtkCell, gencell:vtkGenericCell, cellId:int, tol2:float, subId:int, pcoords:[float, float, float], weights:[float, ...]) -> int: ...
    def FindPoint(self, x:[float, float, float]) -> int: ...
    ...
    def GetCellBounds(self, cellId:int, bounds:[float, float, float, float, float, float]) -> None: ...
    @overload
    def GetCellPoints(self, cellId:int, ptIds:vtkIdList) -> None: ...
    @overload
    def GetCellPoints(self, cellId:int, npts:int, pts:(int, ...), ptIds:vtkIdList) -> None: ...
    ...
    @overload
    def GetPoint(self, ptId:int) -> (float, float, float): ...
    @overload
    def GetPoint(self, id:int, x:[float, float, float]) -> None: ...
