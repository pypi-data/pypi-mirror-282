...
class vtkVPICReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetXLayout(self) -> (int, int): ...
    def GetYLayout(self) -> (int, int): ...
    def GetZLayout(self) -> (int, int): ...
    ...
    @overload
    def SetXExtent(self, _arg:(int, int)) -> None: ...
    @overload
    def SetYExtent(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetYExtent(self, _arg:(int, int)) -> None: ...
    @overload
    def SetZExtent(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetZExtent(self, _arg:(int, int)) -> None: ...
