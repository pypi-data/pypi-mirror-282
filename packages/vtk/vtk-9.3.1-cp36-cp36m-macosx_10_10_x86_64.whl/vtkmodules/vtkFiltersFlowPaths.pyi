...
class vtkLinearTransformCellLocator(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    ...
    @overload
    def FindCell(self, x:[float, float, float], tol2:float, cell:vtkGenericCell, subId:int, pcoords:[float, float, float], weights:[float, ...]) -> int: ...
    @overload
    ...
    def FindCellsAlongLine(self, p1:(float, float, float), p2:(float, float, float), tolerance:float, cellsIds:vtkIdList) -> None: ...
    def FindCellsAlongPlane(self, o:(float, float, float), n:(float, float, float), tolerance:float, cells:vtkIdList) -> None: ...
    def FindCellsWithinBounds(self, bbox:[float, ...], cells:vtkIdList) -> None: ...
    @overload
    def FindClosestPoint(self, x:(float, float, float), closestPoint:[float, float, float], cell:vtkGenericCell, cellId:int, subId:int, dist2:float) -> None: ...
    @overload
    def FindClosestPoint(self, x:(float, float, float), closestPoint:[float, float, float], cellId:int, subId:int, dist2:float) -> None: ...
    @overload
    def FindClosestPointWithinRadius(self, x:[float, float, float], radius:float, closestPoint:[float, float, float], cell:vtkGenericCell, cellId:int, subId:int, dist2:float, inside:int) -> int: ...
    @overload
    def FindClosestPointWithinRadius(self, x:[float, float, float], radius:float, closestPoint:[float, float, float], cellId:int, subId:int, dist2:float) -> int: ...
    @overload
    def FindClosestPointWithinRadius(self, x:[float, float, float], radius:float, closestPoint:[float, float, float], cell:vtkGenericCell, cellId:int, subId:int, dist2:float) -> int: ...
    ...
    def InsideCellBounds(self, x:[float, float, float], cellId:int) -> bool: ...
    @overload
...
class vtkModifiedBSPTree(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    def BuildLocator(self) -> None: ...
    @overload
    def FindCell(self, x:[float, float, float], tol2:float, GenCell:vtkGenericCell, subId:int, pcoords:[float, float, float], weights:[float, ...]) -> int: ...
    @overload
    def FindCell(self, x:[float, float, float]) -> int: ...
    @overload
    def FindCell(self, x:[float, float, float], tol2:float, GenCell:vtkGenericCell, pcoords:[float, float, float], weights:[float, ...]) -> int: ...
