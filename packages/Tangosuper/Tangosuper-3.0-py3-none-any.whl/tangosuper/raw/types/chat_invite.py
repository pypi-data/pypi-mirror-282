...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <tangosuper.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <tangosuper.raw.base.User>`, *optional*):
            N/A
