...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <tangosuper.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <tangosuper.raw.base.auth.CodeType>`, *optional*):
            N/A
