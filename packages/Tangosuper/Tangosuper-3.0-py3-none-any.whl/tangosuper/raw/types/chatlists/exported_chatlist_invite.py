...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <tangosuper.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <tangosuper.raw.base.ExportedChatlistInvite>`):
            N/A
