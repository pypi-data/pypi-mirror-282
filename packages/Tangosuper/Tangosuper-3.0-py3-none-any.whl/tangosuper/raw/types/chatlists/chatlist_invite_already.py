...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <tangosuper.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <tangosuper.raw.base.Peer>`):
            N/A
