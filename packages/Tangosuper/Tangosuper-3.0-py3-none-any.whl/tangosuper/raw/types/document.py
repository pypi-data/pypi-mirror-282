...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <tangosuper.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <tangosuper.raw.base.VideoSize>`, *optional*):
            N/A
