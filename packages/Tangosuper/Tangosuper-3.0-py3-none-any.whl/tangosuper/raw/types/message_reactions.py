...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <tangosuper.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <tangosuper.raw.base.MessagePeerReaction>`, *optional*):
            N/A
