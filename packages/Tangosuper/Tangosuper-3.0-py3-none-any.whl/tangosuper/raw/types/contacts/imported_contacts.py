...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <tangosuper.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <tangosuper.raw.base.PopularContact>`):
            N/A
