...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <tangosuper.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <tangosuper.raw.base.Peer>`):
            N/A
