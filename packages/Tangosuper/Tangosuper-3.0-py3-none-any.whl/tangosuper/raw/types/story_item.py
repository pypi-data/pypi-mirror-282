...
class StoryItem(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.StoryItem`.
    ...
    Parameters:
        ...
        media (:obj:`MessageMedia <tangosuper.raw.base.MessageMedia>`):
            N/A
        ...
        media_areas (List of :obj:`MediaArea <tangosuper.raw.base.MediaArea>`, *optional*):
            N/A

        privacy (List of :obj:`PrivacyRule <tangosuper.raw.base.PrivacyRule>`, *optional*):
            N/A

        views (:obj:`StoryViews <tangosuper.raw.base.StoryViews>`, *optional*):
            N/A

        sent_reaction (:obj:`Reaction <tangosuper.raw.base.Reaction>`, *optional*):
            N/A
