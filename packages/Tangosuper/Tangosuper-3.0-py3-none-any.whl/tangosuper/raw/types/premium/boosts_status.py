...
class BoostsStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.premium.BoostsStatus`.
    ...
    Parameters:
        ...
        premium_audience (:obj:`StatsPercentValue <tangosuper.raw.base.StatsPercentValue>`, *optional*):
            N/A

        prepaid_giveaways (List of :obj:`PrepaidGiveaway <tangosuper.raw.base.PrepaidGiveaway>`, *optional*):
            N/A
