...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <tangosuper.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <tangosuper.raw.base.VideoSize>`, *optional*):
            N/A
