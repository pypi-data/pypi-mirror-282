...
class SponsoredMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.SponsoredMessage`.
    ...
    Parameters:
        ...
        chat_invite (:obj:`ChatInvite <tangosuper.raw.base.ChatInvite>`, *optional*):
            N/A
        ...
        webpage (:obj:`SponsoredWebPage <tangosuper.raw.base.SponsoredWebPage>`, *optional*):
            N/A
