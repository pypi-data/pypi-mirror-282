...
class WebPage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.WebPage`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <tangosuper.raw.base.Photo>`, *optional*):
            N/A
        ...
        document (:obj:`Document <tangosuper.raw.base.Document>`, *optional*):
            N/A

        cached_page (:obj:`Page <tangosuper.raw.base.Page>`, *optional*):
            N/A

        attributes (List of :obj:`WebPageAttribute <tangosuper.raw.base.WebPageAttribute>`, *optional*):
            N/A
