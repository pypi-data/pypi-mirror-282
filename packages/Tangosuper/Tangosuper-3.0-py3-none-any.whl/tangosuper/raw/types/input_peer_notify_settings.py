...
class InputPeerNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.InputPeerNotifySettings`.
    ...
    Parameters:
        ...
        sound (:obj:`NotificationSound <tangosuper.raw.base.NotificationSound>`, *optional*):
            N/A
        ...
        stories_sound (:obj:`NotificationSound <tangosuper.raw.base.NotificationSound>`, *optional*):
            N/A
