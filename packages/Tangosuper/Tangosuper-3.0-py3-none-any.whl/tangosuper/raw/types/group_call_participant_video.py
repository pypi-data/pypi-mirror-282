...
class GroupCallParticipantVideo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.GroupCallParticipantVideo`.
    ...
    Parameters:
        ...
        source_groups (List of :obj:`GroupCallParticipantVideoSourceGroup <tangosuper.raw.base.GroupCallParticipantVideoSourceGroup>`):
            N/A
