...
class MessageReplyHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.MessageReplyHeader`.
    ...
    Parameters:
        ...
        reply_to_peer_id (:obj:`Peer <tangosuper.raw.base.Peer>`, *optional*):
            N/A

        reply_from (:obj:`MessageFwdHeader <tangosuper.raw.base.MessageFwdHeader>`, *optional*):
            N/A

        reply_media (:obj:`MessageMedia <tangosuper.raw.base.MessageMedia>`, *optional*):
            N/A
        ...
        quote_entities (List of :obj:`MessageEntity <tangosuper.raw.base.MessageEntity>`, *optional*):
            N/A
