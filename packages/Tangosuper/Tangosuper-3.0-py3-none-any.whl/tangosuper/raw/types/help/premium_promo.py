...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <tangosuper.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <tangosuper.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <tangosuper.raw.base.PremiumSubscriptionOption>`):
            N/A
