...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <tangosuper.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <tangosuper.raw.base.Document>`, *optional*):
            N/A
