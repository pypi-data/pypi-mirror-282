...
class RequestPeerTypeBroadcast(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.RequestPeerType`.
    ...
    Parameters:
        ...
        user_admin_rights (:obj:`ChatAdminRights <tangosuper.raw.base.ChatAdminRights>`, *optional*):
            N/A

        bot_admin_rights (:obj:`ChatAdminRights <tangosuper.raw.base.ChatAdminRights>`, *optional*):
            N/A
