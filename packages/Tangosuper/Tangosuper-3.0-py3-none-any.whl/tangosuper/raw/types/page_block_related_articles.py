...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <tangosuper.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <tangosuper.raw.base.PageRelatedArticle>`):
            N/A
