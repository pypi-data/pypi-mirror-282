...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        ...
        shipping_options (List of :obj:`ShippingOption <tangosuper.raw.base.ShippingOption>`, *optional*):
            N/A
