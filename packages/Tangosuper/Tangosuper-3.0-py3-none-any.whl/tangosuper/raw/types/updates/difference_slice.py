...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <tangosuper.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <tangosuper.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <tangosuper.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <tangosuper.raw.base.updates.State>`):
            N/A
