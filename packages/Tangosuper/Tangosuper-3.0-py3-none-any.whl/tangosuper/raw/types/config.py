...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <tangosuper.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <tangosuper.raw.base.Reaction>`, *optional*):
            N/A
