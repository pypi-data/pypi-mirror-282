...
class Page(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.Page`.
    ...
    Parameters:
        ...
        blocks (List of :obj:`PageBlock <tangosuper.raw.base.PageBlock>`):
            N/A

        photos (List of :obj:`Photo <tangosuper.raw.base.Photo>`):
            N/A
