...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <tangosuper.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <tangosuper.raw.base.GroupCallParticipant>`):
            N/A
