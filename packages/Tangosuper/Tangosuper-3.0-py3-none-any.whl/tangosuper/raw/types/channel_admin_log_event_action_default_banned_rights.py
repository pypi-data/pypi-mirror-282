...
class ChannelAdminLogEventActionDefaultBannedRights(TLObject):  # type: ignore
    ...
    Parameters:
        prev_banned_rights (:obj:`ChatBannedRights <tangosuper.raw.base.ChatBannedRights>`):
            N/A

        new_banned_rights (:obj:`ChatBannedRights <tangosuper.raw.base.ChatBannedRights>`):
            N/A
