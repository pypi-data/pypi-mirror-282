...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <tangosuper.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <tangosuper.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <tangosuper.raw.base.WebDocument>`, *optional*):
            N/A
