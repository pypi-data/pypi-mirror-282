...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <tangosuper.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <tangosuper.raw.base.InputPeer>`, *optional*):
            N/A
