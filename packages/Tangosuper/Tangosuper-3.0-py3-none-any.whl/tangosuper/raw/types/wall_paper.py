...
class WallPaper(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.WallPaper`.
    ...
    Parameters:
        ...
        document (:obj:`Document <tangosuper.raw.base.Document>`):
            N/A
        ...
        settings (:obj:`WallPaperSettings <tangosuper.raw.base.WallPaperSettings>`, *optional*):
            N/A
