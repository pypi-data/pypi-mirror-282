...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <tangosuper.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <tangosuper.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <tangosuper.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <tangosuper.raw.base.InputDocument>`, *optional*):
            N/A
