...
class InputInvoicePremiumGiftCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.InputInvoice`.
    ...
    Parameters:
        purpose (:obj:`InputStorePaymentPurpose <tangosuper.raw.base.InputStorePaymentPurpose>`):
            N/A

        option (:obj:`PremiumGiftCodeOption <tangosuper.raw.base.PremiumGiftCodeOption>`):
            N/A
