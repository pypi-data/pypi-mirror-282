...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <tangosuper.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <tangosuper.raw.base.SecureSecretSettings>`, *optional*):
            N/A
