...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <tangosuper.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <tangosuper.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <tangosuper.raw.base.SecureValueError>`):
            N/A
