...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        icons (List of :obj:`AttachMenuBotIcon <tangosuper.raw.base.AttachMenuBotIcon>`):
            N/A
        ...
        peer_types (List of :obj:`AttachMenuPeerType <tangosuper.raw.base.AttachMenuPeerType>`, *optional*):
            N/A
