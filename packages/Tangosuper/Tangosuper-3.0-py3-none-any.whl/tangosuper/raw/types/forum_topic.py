...
class ForumTopic(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.ForumTopic`.
    ...
    Parameters:
        ...
        from_id (:obj:`Peer <tangosuper.raw.base.Peer>`):
            N/A
        ...
        draft (:obj:`DraftMessage <tangosuper.raw.base.DraftMessage>`, *optional*):
            N/A
