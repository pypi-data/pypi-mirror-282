...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <tangosuper.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <tangosuper.raw.base.Message>`):
            N/A
