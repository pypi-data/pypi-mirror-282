...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <tangosuper.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <tangosuper.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <tangosuper.raw.base.InlineBotWebView>`, *optional*):
            N/A
