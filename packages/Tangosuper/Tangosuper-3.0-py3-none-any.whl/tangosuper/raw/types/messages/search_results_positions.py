...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <tangosuper.raw.base.SearchResultsPosition>`):
            N/A
