...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.messages.StickerSet`.
    ...
    Parameters:
        ...
        packs (List of :obj:`StickerPack <tangosuper.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <tangosuper.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <tangosuper.raw.base.Document>`):
            N/A
