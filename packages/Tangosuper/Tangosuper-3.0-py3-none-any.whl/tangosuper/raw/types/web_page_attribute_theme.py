...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tangosuper.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <tangosuper.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <tangosuper.raw.base.ThemeSettings>`, *optional*):
            N/A
