...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <tangosuper.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <tangosuper.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <tangosuper.raw.base.phone.GroupParticipants>`
    """
