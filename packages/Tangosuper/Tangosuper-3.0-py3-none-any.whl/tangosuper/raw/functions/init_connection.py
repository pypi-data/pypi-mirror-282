...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~tangosuper.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <tangosuper.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <tangosuper.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~tangosuper.raw.types`
    """
