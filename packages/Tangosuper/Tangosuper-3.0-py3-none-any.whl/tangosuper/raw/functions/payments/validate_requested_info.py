...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        info (:obj:`PaymentRequestedInfo <tangosuper.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <tangosuper.raw.base.payments.ValidatedRequestedInfo>`
    """
