...
class SendPaymentForm(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        credentials (:obj:`InputPaymentCredentials <tangosuper.raw.base.InputPaymentCredentials>`):
            N/A
    ...
    Returns:
        :obj:`payments.PaymentResult <tangosuper.raw.base.payments.PaymentResult>`
    """
