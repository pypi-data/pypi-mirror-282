...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <tangosuper.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <tangosuper.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <tangosuper.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <tangosuper.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <tangosuper.raw.base.photos.Photo>`
    """
