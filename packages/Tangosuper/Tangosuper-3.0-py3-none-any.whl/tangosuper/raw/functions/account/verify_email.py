...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <tangosuper.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <tangosuper.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <tangosuper.raw.base.account.EmailVerified>`
    """
