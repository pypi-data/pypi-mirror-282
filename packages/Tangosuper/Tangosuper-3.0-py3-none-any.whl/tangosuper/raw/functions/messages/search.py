...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <tangosuper.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <tangosuper.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <tangosuper.raw.base.messages.Messages>`
    """
