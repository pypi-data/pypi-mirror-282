...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        stickers (List of :obj:`InputStickerSetItem <tangosuper.raw.base.InputStickerSetItem>`):
            N/A
        ...
        thumb (:obj:`InputDocument <tangosuper.raw.base.InputDocument>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.StickerSet <tangosuper.raw.base.messages.StickerSet>`
    """
