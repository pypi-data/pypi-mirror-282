...
async def compose(
    clients: List["tangosuper.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``tangosuper`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~tangosuper.Client.run`.

    Parameters:
        clients (List of :obj:`~tangosuper.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from tangosuper import Client, compose
