...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~tangosuper.Client.stop` and then :meth:`~tangosuper.Client.start` in a row in
        ...
        Returns:
            :obj:`~tangosuper.Client`: The restarted client itself.
