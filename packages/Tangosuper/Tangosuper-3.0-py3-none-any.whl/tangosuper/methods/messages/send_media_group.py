...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~tangosuper.types.InputMediaPhoto`, :obj:`~tangosuper.types.InputMediaVideo`, :obj:`~tangosuper.types.InputMediaAudio` and :obj:`~tangosuper.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~tangosuper.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from tangosuper.types import InputMediaPhoto, InputMediaVideo
