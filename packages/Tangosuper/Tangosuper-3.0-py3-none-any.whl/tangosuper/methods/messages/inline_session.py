...
from tangosuper.errors import AuthBytesInvalid
from tangosuper.session import Session
from tangosuper.session.auth import Auth


async def get_session(client: "tangosuper.Client", dc_id: int):
