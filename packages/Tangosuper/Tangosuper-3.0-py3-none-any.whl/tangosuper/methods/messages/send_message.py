...
import tangosuper
from tangosuper import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~tangosuper.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **Tangosuper**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.tangosuper.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.tangosuper.org")]
                        ]))
        """
