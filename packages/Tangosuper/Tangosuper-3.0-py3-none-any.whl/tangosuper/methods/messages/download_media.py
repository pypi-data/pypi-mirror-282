...
from tangosuper.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~tangosuper.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~tangosuper.Client.stop_transmission`, None is returned.
