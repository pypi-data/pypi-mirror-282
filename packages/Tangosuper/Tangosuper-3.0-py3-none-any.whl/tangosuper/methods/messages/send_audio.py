...
import tangosuper
from tangosuper import StopTransmission, enums
from tangosuper import raw
from tangosuper import types
from tangosuper import utils
from tangosuper.errors import FilePartMissing
from tangosuper.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~tangosuper.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~tangosuper.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~tangosuper.Client.stop_transmission`, None is returned.
