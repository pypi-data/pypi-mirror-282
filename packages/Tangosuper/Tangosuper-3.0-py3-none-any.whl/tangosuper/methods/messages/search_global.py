...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~tangosuper.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~tangosuper.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~tangosuper.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "tangosuper". Get the first 50 results
                async for message in app.search_global("tangosuper", limit=50):
                    print(message.text)
