...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~tangosuper.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, tangosuper.Client):
                self.add_handler(tangosuper.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        tangosuper.handlers.ChatJoinRequestHandler(func, self),
