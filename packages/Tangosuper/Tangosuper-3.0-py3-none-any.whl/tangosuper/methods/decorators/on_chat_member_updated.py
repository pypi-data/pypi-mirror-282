...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~tangosuper.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, tangosuper.Client):
                self.add_handler(tangosuper.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        tangosuper.handlers.ChatMemberUpdatedHandler(func, self),
