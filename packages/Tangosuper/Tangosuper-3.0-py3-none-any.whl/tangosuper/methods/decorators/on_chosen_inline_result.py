...
import tangosuper
from tangosuper.filters import Filter
...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        This does the same thing as :meth:`~tangosuper.Client.add_handler` using the
        :obj:`~tangosuper.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~tangosuper.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, tangosuper.Client):
                self.add_handler(tangosuper.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        tangosuper.handlers.ChosenInlineResultHandler(func, self),
