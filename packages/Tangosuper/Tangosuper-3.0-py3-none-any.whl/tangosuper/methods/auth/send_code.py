...
from tangosuper.errors import PhoneMigrate, NetworkMigrate
from tangosuper.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~tangosuper.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
