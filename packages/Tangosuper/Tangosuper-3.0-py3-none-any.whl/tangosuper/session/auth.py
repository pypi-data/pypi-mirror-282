...
from tangosuper.connection import Connection
from tangosuper.crypto import aes, rsa, prime
from tangosuper.errors import SecurityCheckMismatch
from tangosuper.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "tangosuper.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
