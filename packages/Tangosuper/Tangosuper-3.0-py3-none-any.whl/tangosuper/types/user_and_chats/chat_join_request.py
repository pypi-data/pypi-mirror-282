...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        chat (:obj:`~tangosuper.types.Chat`):
        ...
        invite_link (:obj:`~tangosuper.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~tangosuper.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~tangosuper.types.ChatJoinRequest`.
