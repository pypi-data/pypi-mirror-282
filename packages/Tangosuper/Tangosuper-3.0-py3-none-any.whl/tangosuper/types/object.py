...
class Object:
    def __init__(self, client: "tangosuper.Client" = None):
        self._client = client

    def bind(self, client: "tangosuper.Client"):
        """Bind a Client instance to this and to all nested Tangosuper objects.

        Parameters:
            client (:obj:`~tangosuper.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing Tangosuper objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/tangosuperchat/167281
    ...
    def __repr__(self) -> str:
        return "tangosuper.types.{}({})".format(
