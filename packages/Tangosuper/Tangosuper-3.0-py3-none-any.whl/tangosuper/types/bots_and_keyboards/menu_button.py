...
class MenuButton(Object):
    ...
    - :obj:`~tangosuper.types.MenuButtonCommands`
    - :obj:`~tangosuper.types.MenuButtonWebApp`
    - :obj:`~tangosuper.types.MenuButtonDefault`

    If a menu button other than :obj:`~tangosuper.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "tangosuper.Client") -> "raw.base.BotMenuButton":
