...
class BotCommandScope(Object):
    ...
    - :obj:`~tangosuper.types.BotCommandScopeDefault`
    - :obj:`~tangosuper.types.BotCommandScopeAllPrivateChats`
    - :obj:`~tangosuper.types.BotCommandScopeAllGroupChats`
    - :obj:`~tangosuper.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~tangosuper.types.BotCommandScopeChat`
    - :obj:`~tangosuper.types.BotCommandScopeChatAdministrators`
    - :obj:`~tangosuper.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "tangosuper.Client") -> "raw.base.BotCommandScope":
