...
import tangosuper
from tangosuper import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~tangosuper.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~tangosuper.types.MessageEntity`, *optional*):
