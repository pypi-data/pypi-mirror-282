...
from tangosuper.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "tangosuper.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~tangosuper.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~tangosuper.handlers.MessageHandler` the *update* argument will be a :obj:`~tangosuper.types.Message`; in a :obj:`~tangosuper.handlers.CallbackQueryHandler` the *update* will be a :obj:`~tangosuper.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~tangosuper.filters.command` or :meth:`~tangosuper.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~tangosuper.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Document` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Game` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Video` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Location` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~tangosuper.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~tangosuper.types.Message`.
    ...
    async def func(flt, client: tangosuper.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~tangosuper.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~tangosuper.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~tangosuper.types.InlineQuery`: The filter will match ``query``.
