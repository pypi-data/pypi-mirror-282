...
import tangosuper
from tangosuper import __version__, __license__
from tangosuper import enums
from tangosuper import raw
from tangosuper import utils
from tangosuper.crypto import aes
from tangosuper.errors import CDNFileHashMismatch
from tangosuper.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from tangosuper.handlers.handler import Handler
from tangosuper.methods import Methods
from tangosuper.session import Auth, Session
from tangosuper.storage import FileStorage, MemoryStorage
from tangosuper.types import User, TermsOfService
from tangosuper.utils import ainput
...
class Client(Methods):
    """Tangosuper Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~tangosuper.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Tangosuper will store the session files.
    ...
    APP_VERSION = f"Tangosuper {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Tangosuper (version {__version__})")
        print(f"Tangosuper is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~tangosuper.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.tangosuper.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except tangosuper.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
