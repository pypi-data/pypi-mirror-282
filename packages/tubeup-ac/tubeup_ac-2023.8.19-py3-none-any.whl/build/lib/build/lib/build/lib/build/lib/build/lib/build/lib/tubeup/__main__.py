...
Options:
  ...
  --ydl-option-format <format> Youtube-dlc option format (ex: "bestvideo[height<=1280]+bestaudio")
  --ydl-option-subtitleslangs <subtitleslangs> Youtube-dlc option subtitleslangs (ex: "all,-live_chat")
"""
