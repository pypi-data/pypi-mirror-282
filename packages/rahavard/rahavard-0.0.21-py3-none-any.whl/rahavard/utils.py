...
def add_yearmonthday_firtn_lastn_wipeout(parser):
    parser.add_argument(
...
def colorize(self, mode, text):
    ...
    if mode == 'accomplished_in': return self.style.SUCCESS(text)            ## bold green
    if mode == 'done':            return self.style.SUCCESS(text)            ## bold green
    if mode == 'fetched_in':      return self.style.SUCCESS(text)            ## bold green
    if mode == 'updated_in':      return self.style.SUCCESS(text)            ## bold green
