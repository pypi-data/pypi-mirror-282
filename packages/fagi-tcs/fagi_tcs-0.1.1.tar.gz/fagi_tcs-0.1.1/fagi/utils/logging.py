...
def get_truncation_warning_message(instance, limit) -> str:
    return (
        ...
        "automatically truncated upon ingestion into the fagi platform. Should you require "
        "a higher limit, please reach out to our support team at support@fagi.com"
    )