...
You can use superbase to directly connect to instances and write your own logic. You first need to install `pip install supabase` since this package does not install the dep to keep the bundle small and lazy imports the client.
