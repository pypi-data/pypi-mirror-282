...
class Abstraction:
    ...
    def get_abstract_state_index(self, arg0: State) -> int:
        ...
    def get_backward_transition_adjacency_lists(self) -> list[...]:
        ...
    def get_deadend_states(self) -> set[int]:
        ...
    def get_forward_transition_adjacency_lists(self) -> list[...]:
        ...
...
class FaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepath: str, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(parser: PDDLParser, aag: IAAG, ssg: SuccessorStateGenerator, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, SuccessorStateGenerator]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
...
class GlobalFaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, SuccessorStateGenerator]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
    def get_aag(self) -> IAAG:
        ...
    def get_abstract_state_index(self, arg0: State) -> int:
