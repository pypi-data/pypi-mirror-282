...
class FaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepath: str, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, prune_isomorphic_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(parser: PDDLParser, aag: IAAG, ssg: SuccessorStateGenerator, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, prune_isomorphic_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, prune_isomorphic_states: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, SuccessorStateGenerator]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, prune_isomorphic_states: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
...
class GlobalFaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, prune_isomorphic_states: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, SuccessorStateGenerator]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, prune_isomorphic_states: bool = True, sort_ascending_by_num_states: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
