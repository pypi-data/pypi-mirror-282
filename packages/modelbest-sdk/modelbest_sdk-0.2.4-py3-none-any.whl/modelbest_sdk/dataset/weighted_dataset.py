...
class WeightedDataset(torch.utils.data.IterableDataset):
    def __init__(
        ...
        def process_dataset_info(dataset_info: DatasetInfo):
            ...
            if weight == 0:
                logger.warning(f"Dataset {path} has weight 0, won't sample, but will initialize it")
                # continue
            ...
            return dataset, prefetch_chunk_dataset, weight
    ...
    def init_broadcast(self, dp_group):
            ...
            with ThreadPoolExecutor() as executor:
                ...
                for future in as_completed(futures):
                    ...
                    try:
                        ...
                        logger.error(f"Dataset initialization failed at index {idx} with error: {e}")
        ...
        torch.distributed.broadcast_object_list(broadcast_list, src=0, group=dp_group)
