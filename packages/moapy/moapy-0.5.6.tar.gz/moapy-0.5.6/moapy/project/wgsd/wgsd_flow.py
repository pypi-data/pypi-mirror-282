...
class Stress_Strain_Curve_Conc(BaseModel):
    """
    Stress strain curve class
    """
    ss_curve: list[Stress_Strain_Component] = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.0006, stress=0.0), Stress_Strain_Component(strain=0.0006, stress=34.0), Stress_Strain_Component(strain=0.003, stress=34.0)], description="Stress strain curve concrete")

    class Config:
        title = "Stress Strain Curve Concrete"

class Stress_Strain_Curve_Rebar(BaseModel):
    """
    Stress strain curve class
    """
    ss_curve: list[Stress_Strain_Component] = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.0025, stress=500.0), Stress_Strain_Component(strain=0.05, stress=500.0)], description="Stress strain curve rebar")

    class Config:
        title = "Stress Strain Curve Rebar"

class Stress_Strain_Curve_Tendon(BaseModel):
    """
    Stress strain curve class
    """
    ss_curve: list[Stress_Strain_Component] = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.00725, stress=1450.0), Stress_Strain_Component(strain=0.05, stress=1750.0)], description="Stress strain curve tendon")

    class Config:
        title = "Stress Strain Curve Tendon"
...
class MaterialRebar(BaseModel):
    ...
    curve_uls: Stress_Strain_Curve_Rebar = dataclass_field(default=Stress_Strain_Curve_Rebar(), description="Stress strain curve")
    curve_sls: Stress_Strain_Curve_Rebar = dataclass_field(default=Stress_Strain_Curve_Rebar(), description="Stress strain curve")
...
class MaterialTendon(BaseModel):
    ...
    curve_uls: Stress_Strain_Curve_Tendon = dataclass_field(default=Stress_Strain_Curve_Tendon(), description="Stress strain curve")
    curve_sls: Stress_Strain_Curve_Tendon = dataclass_field(default=Stress_Strain_Curve_Tendon(), description="Stress strain curve")
...
class MaterialConcrete(BaseModel):
    ...
    curve_uls: Stress_Strain_Curve_Conc = dataclass_field(default=Stress_Strain_Curve_Conc(), description="Stress strain curve")
    curve_sls: Stress_Strain_Curve_Conc = dataclass_field(default=Stress_Strain_Curve_Conc(), description="Stress strain curve")
...
class RebarPoints(BaseModel):
    ...
    """
    points: list[Point] = dataclass_field(default=[[40.0, 40.0], [360.0, 40.0], [360.0, 560.0], [40.0, 560.0]], description="Rebar Points")
...
class TendonPoints(BaseModel):
    ...
    """
    points: list[Point] = dataclass_field(default=[[200.0, 100.0]], description="Tendon Points")
...
def conc_properties_design(
    ...
    return MaterialConcrete(curve_uls=Stress_Strain_Curve_Conc(ss_curve=ss_uls_components), curve_sls=Stress_Strain_Curve_Conc(ss_curve=ss_sls_components))
...
def rebar_properties_design(
    ...
    return MaterialRebar(curve_uls=Stress_Strain_Curve_Rebar(ss_curve=ss_uls_components), curve_sls=Stress_Strain_Curve_Rebar(ss_curve=ss_sls_components))
