...
class Lcoms(BaseModel):
    ...
    """
    lcoms: list[Lcom] = dataclass_field(default=[], description="load combination result")
...
class Result3DPM(BaseModel):
    ...
    strength: Lcoms = dataclass_field(default=Lcoms(), description="Strength result")
...
class Stress_Strain_Curve(BaseModel):
    ...
    """
    ss_curve: list[Stress_Strain_Component] = dataclass_field(default=[], description="Stress strain curve")
...
class MaterialRebar(BaseModel):
    ...
    curve_uls: Stress_Strain_Curve = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.0025, stress=500.0), Stress_Strain_Component(strain=0.05, stress=500.0)], description="Stress strain curve")
    curve_sls: Stress_Strain_Curve = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.0025, stress=500.0), Stress_Strain_Component(strain=0.05, stress=500.0)], description="Stress strain curve")
...
class MaterialTendon(BaseModel):
    ...
    curve_uls: Stress_Strain_Curve = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.00725, stress=1450.0), Stress_Strain_Component(strain=0.05, stress=1750.0)], description="Stress strain curve")
    curve_sls: Stress_Strain_Curve = dataclass_field(default=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.00725, stress=1450.0), Stress_Strain_Component(strain=0.05, stress=1750.0)], description="Stress strain curve")
...
class MaterialConcrete(BaseModel):
    ...
    curve_uls: Stress_Strain_Curve = dataclass_field(
        default=Stress_Strain_Curve(ss_curve=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.0006, stress=0.0), Stress_Strain_Component(strain=0.0006, stress=34.0), Stress_Strain_Component(strain=0.003, stress=34.0)]), description="Stress strain curve")
    curve_sls: Stress_Strain_Curve = dataclass_field(
        default=Stress_Strain_Curve(ss_curve=[Stress_Strain_Component(strain=0.0, stress=0.0), Stress_Strain_Component(strain=0.001, stress=32.8)]), description="Stress strain curve")
...
class RebarGeometry(BaseModel):
    ...
    """
    position: Points = dataclass_field(default=[[40.0, 40.0], [360.0, 40.0], [360.0, 560.0], [40.0, 560.0]], description="position of the rebar")
    prop: RebarProp = dataclass_field(
        default=RebarProp(), description="properties of the rebar")
...
class TendonGeometry(BaseModel):
    ...
    """
    position: Points = dataclass_field(default=[[200.0, 100.0]], description="position of the tender")
...
class Lcb(BaseModel):
    ...
    """
    uls: Lcoms = dataclass_field(default=Lcoms(Lcoms=[Lcom(name="uls1", f=Force(Nz=100.0, Mx=10.0, My=50.0)), Lcom(name="uls2", f=Force(Nz=100.0, Mx=15.0, My=50.0))]), description="uls load combination")
...
def conc_properties_design(
    ...
    end_time = time.time()
    print("Total function execution time:", end_time - start_time, "seconds")
    return MaterialConcrete(curve_uls=Stress_Strain_Curve(ss_curve=ss_uls_components), curve_sls=Stress_Strain_Curve(ss_curve=ss_sls_components))
...
def rebar_properties_design(
    ...
    return MaterialRebar(curve_uls=Stress_Strain_Curve(ss_curve=ss_uls_components), curve_sls=Stress_Strain_Curve(ss_curve=ss_sls_components))
...
class PM3DCurve:
    ...
    def get_concrete_material_curve(self, type_):
        ...
        return [component.stress for component in curve_data.ss_curve], [component.strain for component in curve_data.ss_curve]
...
def calc_3dpm(material: Material, geometry: Geometry, lcb: Lcb, opt: PMOptions) -> Result3DPM:
    ...
    lcomRes = Lcoms(lcoms=result_lcom_uls)
    end_time = time.time()
    print("Total function execution time:", end_time - start_time, "seconds")
    return Result3DPM(meshes=meshData, strength=lcomRes)
...
@auto_schema
def options_design(by_ecc_pu: str) -> PMOptions:
    return PMOptions(by_ecc_pu=by_ecc_pu)