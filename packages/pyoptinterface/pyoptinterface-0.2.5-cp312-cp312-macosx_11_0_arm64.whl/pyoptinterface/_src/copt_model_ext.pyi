...
class RawModel(_RawModelBase):
    ...
    def add_second_order_cone_constraint(self, variables: Sequence[pyoptinterface._src.core_ext.VariableIndex], name: str = '') -> pyoptinterface._src.core_ext.ConstraintIndex: ...
