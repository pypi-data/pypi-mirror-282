...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, hidden=False, base_url=None, pulp_href=None, pulp_labels=None, pulp_last_updated=None, content_guard=None, name=None, base_path=None, local_vars_configuration=None):  # noqa: E501
