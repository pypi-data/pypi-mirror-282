...
class Mixture:
    def __init__(self, components: list, ions: list = None, setprops: bool = True,
                 name: str = "Untitled", composition: list = None, np_max: int = None):
        self.name = name
...
class M3(Mixture):
    ...
    """
    def __init__(self):
        super().__init__(name="M3", components=["C1", "CO2", "H2S"], setprops=False,
...
class DepletedOilMixture(Mixture):
    ...
    """
    def __init__(self):
        super().__init__(name="DepletedOilMixture", components=["C1", "nC10", "CO2"], setprops=False,
                         np_max=3)
