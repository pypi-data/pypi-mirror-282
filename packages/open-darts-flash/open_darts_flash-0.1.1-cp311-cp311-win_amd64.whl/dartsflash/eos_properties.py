...
class EoSProperty:
    """
    This class can evaluate thermodynamic properties from an Equation of State (EoS) object.
    """
...
class VdWPProperty(EoSProperty):
    """
    This class can evaluate hydrate thermodynamic properties from a Van der Waals-Platteeuw EoS (VdWP) object.
    """
...
class VdWPDensity(VdWPProperty):
    """
    This class can evaluate hydrate density (molar volume) from a VdWP object.
    """
...
class VdWPEnthalpy(VdWPProperty):
    """
