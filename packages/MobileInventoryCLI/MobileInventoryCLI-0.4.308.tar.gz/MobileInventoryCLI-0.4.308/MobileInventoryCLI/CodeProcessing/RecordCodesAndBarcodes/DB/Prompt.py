...
{color1}Prompt CMDS:[{Fore.green}q={Fore.green_yellow}quit|{Fore.light_sea_green}qb={Fore.green_yellow}backup & quit|{Fore.cyan}b={color2}back|{Fore.light_red}h={color3}help{color4}|{Fore.light_red}h+={color3}help+{color4}|{Fore.light_magenta}i={color3}info|{Fore.orange_red_1}c{Fore.light_steel_blue}=calc{Style.reset}
