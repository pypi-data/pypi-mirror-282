from etiket_client.local.exceptions import ScopeDoesAlreadyExistException,\
    CannotDeleteAScopeWithDatasetsException, MemberHasNoBusinessInThisScopeException,\
    UserAlreadyNotPartOfScopeException, SchemaAlreadyAssignedException, \
    ScopeDoesNotExistException, UserAlreadyPartOfScopeException
