...
from smartdress import Smartdress, AsyncSmartdress, APIResponseValidationError
from smartdress._models import BaseModel, FinalRequestOptions
from smartdress._constants import RAW_RESPONSE_HEADER
from smartdress._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from smartdress._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Smartdress | AsyncSmartdress) -> int:
...
class TestSmartdress:
    client = Smartdress(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "smartdress/_legacy_response.py",
                        "smartdress/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "smartdress/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: Smartdress) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Smartdress(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(SMARTDRESS_BASE_URL="http://localhost:5000/from/env"):
            client = Smartdress(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Smartdress) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Smartdress) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Smartdress) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Smartdress(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Smartdress(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("smartdress._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/v1/recommend_outfit/").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/api/v1/recommend_outfit/",
                body=cast(object, dict(descriptions={"foo": {"foo": "string"}}, query="string")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/v1/recommend_outfit/").mock(return_value=httpx.Response(500))
...
class TestAsyncSmartdress:
    client = AsyncSmartdress(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSmartdress) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(SMARTDRESS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncSmartdress(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncSmartdress) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncSmartdress) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncSmartdress) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSmartdress(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncSmartdress(base_url=base_url, api_key=api_key, _strict_response_validation=False)
