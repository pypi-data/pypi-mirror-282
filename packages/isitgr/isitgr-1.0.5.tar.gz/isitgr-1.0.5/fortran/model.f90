    ...
    type, extends (TCAMBParameters) :: CAMBparams
        ...
        real(dl) :: z_div=0._dl !This is the size of each z-bin !models 1 and 2
        real(dl) :: z_TGR=0._dl !The redshift below which we test GR usueally 2*z_div !models 1 and 2
        real(dl) :: z_tw=0._dl  !transition width between redshift bins !models 1 and 2
        real(dl) :: k_tw=0._dl  !transition width between k-bins. !models 1 and 2
        logical :: t_dep=.false.
        logical :: R_func=.false.
        logical  :: trad_bin=.false.
        ...
        logical :: ISiTGR_growth_index=.false.
