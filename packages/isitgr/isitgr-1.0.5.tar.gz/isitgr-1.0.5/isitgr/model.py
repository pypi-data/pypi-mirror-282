...
class CAMBparams(F2003Class):
    ...
    _fields_ = [
        ...
        ("trad_bin", c_bool, "flag to use traditional binning instead of hybrid binning"),
        ...
        ("gamma_L", c_double, "constant growth index"),
        ...
        ("ISiTGR_growth_index", c_bool, "flag to use (mu,eta=1) parametrization for constant growth index"),
    ...
    def set_cosmology(self, H0: Optional[float] = None, ombh2=0.022, omch2=0.12, omk=0.0,
                      ...
                      theta_H0_range=(10, 100), setter_H0=None, MG_parameterization=None,
                      Q0=0.0, Qinf=0.0, D0=0.0, R0=0.0, Dinf=0.0, Rinf=0.0, s=0.0, k_c=0.01,
                      E11=0.0, E22=0.0, mu0=0.0, Sigma0=0.0, c1=1.0, c2=1.0, Lambda=0.0,
                      gamma_L=0.545, z_div=1.0, z_TGR=2.0, z_tw=0.05, k_tw=0.001,
                      redshift_bins=None, scale_bins = None, scale_bins_method=None,
                      Q1=1.0, Q2=1.0, Q3=1.0, Q4=1.0, D1=1.0, D2=1.0, D3=1.0, D4=1.0,
                      mu1=1.0, mu2=1.0, mu3=1.0, mu4=1.0, eta1=1.0, eta2=1.0, eta3=1.0,
                      eta4=1.0, Sigma1=1.0, Sigma2=1.0, Sigma3=1.0, Sigma4=1.0):
        r"""
        ...
        :param scale_bins_method: Set hybrid or traditional binning method for scale bins.
...
#		**************************************** ISiTGR Modifications **************************************************
        ...
        if MG_parameterization == "mueta":
            ...
            if redshift_bins is True:
                ...
                if scale_bins is True:
                    ...
                    self.z_div=z_div
                    self.k_c=k_c
                    if scale_bins_method is None:
                        raise CAMBError('must set binning method for scale bins')
                    elif scale_bins_method == "traditional":
                        self.trad_bin=True
                        self.k_tw=k_tw
                    elif scale_bins_method == "hybrid":
                        self.trad_bin=False
            else:
        ...
        if MG_parameterization == "growth_index":
            self.GR = 0
            self.ISiTGR_mueta = True
            self.ISiTGR_growth_index = True
