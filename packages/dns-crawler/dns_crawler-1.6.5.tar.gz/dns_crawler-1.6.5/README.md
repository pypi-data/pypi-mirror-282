...
Depending on your OS/distro, you might need to install some system packages. On Debian/Ubuntu, `apt install libicu-dev pkg-config build-essential python3-dev` should do the trick (assuming you already have python3 installed of course).
