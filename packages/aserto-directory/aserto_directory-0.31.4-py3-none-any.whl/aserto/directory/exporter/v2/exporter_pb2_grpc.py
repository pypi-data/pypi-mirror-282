...
from aserto.directory.exporter.v2 import exporter_pb2 as aserto_dot_directory_dot_exporter_dot_v2_dot_exporter__pb2
...
def add_ExporterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Export': grpc.unary_stream_rpc_method_handler(
                    servicer.Export,
                    request_deserializer=aserto_dot_directory_dot_exporter_dot_v2_dot_exporter__pb2.ExportRequest.FromString,
                    response_serializer=aserto_dot_directory_dot_exporter_dot_v2_dot_exporter__pb2.ExportResponse.SerializeToString,
            ),
    }
