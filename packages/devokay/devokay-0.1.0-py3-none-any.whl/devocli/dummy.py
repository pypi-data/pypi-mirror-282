...
import argparse
import os
from devocli.pcsdk import regist_pcsdk, handle_pcsdk
from devocli.find_big_files import FindBigFilesCmd
from devocli.sample import reg_one, reg_two
from devocli.omni import OmniCmd
from devocli.remote import RemoteCmd
from devocli.utf8bom import Utf8bomCmd
...
def cli():
    ...
    utf8bom_cmd = Utf8bomCmd()
    utf8bom_cmd.regist(subparsers)
