...
@bp.route("/")
@page_exc_handler(default_message='Failed to load page "Workflow title 2".')
@require_permission("test_permission_2")
def page():
    """
    Render page "Workflow title 2".

    :return: Response with page HTML.
    """
    return send_from_directory(
        os.path.dirname(os.path.abspath(str(__file__))), "html/testName2/index.html"
    )
...
def api_get_configurations():
    """
    Get configurations for the dropDown in Workflow title 2 page
    """
...
def api_get_views():
    """
    Get views under the selected configuration in Workflow title 2 page
    """
...
def api_get_zones():
    """
    Get zones under the selected view in Workflow title 2 page
    """
