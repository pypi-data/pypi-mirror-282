...
def api_get_configurations():
    """
    Get configurations for the dropDown in A title for an HTML link page
    """
...
def api_get_views():
    """
    Get views under the selected configuration in A title for an HTML link page
    """
...
def api_get_zones():
    """
    Get zones under the selected view in A title for an HTML link page
    """
