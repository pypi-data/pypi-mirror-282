...
module.exports = [
    {
        entry: {
            testWorkflow: './src/pages/testWorkflow/index.js',
        },
        output: {
            path: path.join(__dirname, '../../../workspace/workflows/test_workflow/'),
            publicPath: '/test_workflow/',
            filename: 'js/[name].js',
        ...
        plugins: [
            new HtmlWebpackPlugin({
                ...
                filename: 'html/testWorkflow/index.html',
                chunks: ['testWorkflow'],
            }),
        ],
    },
