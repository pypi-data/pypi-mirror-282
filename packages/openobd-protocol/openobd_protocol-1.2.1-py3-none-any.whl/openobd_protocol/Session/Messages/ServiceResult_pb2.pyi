...
class ServiceResult(_message.Message):
    ...
    result_value: _containers.RepeatedScalarFieldContainer[Result]
    user_feedback_value: UserFeedback
    description: str
    def __init__(self, result_value: _Optional[_Iterable[_Union[Result, str]]] = ..., user_feedback_value: _Optional[_Union[UserFeedback, str]] = ..., description: _Optional[str] = ...) -> None: ...
