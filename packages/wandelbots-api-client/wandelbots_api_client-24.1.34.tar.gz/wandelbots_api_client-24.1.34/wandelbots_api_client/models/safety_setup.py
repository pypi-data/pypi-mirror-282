...
class SafetySetup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["safety_settings", "safety_zones", "robot_model_geometries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "safety_settings": [SafetySetupSafetySettings.from_dict(_item) for _item in obj["safety_settings"]] if obj.get("safety_settings") is not None else None,
            "safety_zones": [SafetySetupSafetyZone.from_dict(_item) for _item in obj["safety_zones"]] if obj.get("safety_zones") is not None else None,
            "robot_model_geometries": [RobotLinkGeometry.from_dict(_item) for _item in obj["robot_model_geometries"]] if obj.get("robot_model_geometries") is not None else None
        })
        return _obj
