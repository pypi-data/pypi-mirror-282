...
class RotationAngles(BaseModel):
    """
    Defines rotation angles and their interpretation. Rotation Vector order: X = Vector[0], Y = Vector[1], Z = Vector[2], W = Vector[3].
    """ # noqa: E501
    angles: Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=4, max_length=4)] = Field(description="The values for the rotation notation.")
