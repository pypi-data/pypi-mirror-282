...
class ColumnRuleItemSearchInputV1(object):
    ...
    def item_type(self):
        ...
        The type of item to search for. If not specified, the rule will search for all item               types. If specified, it must be a valid item type. Common types include Signal, Asset, Condition, and                Scalar.
