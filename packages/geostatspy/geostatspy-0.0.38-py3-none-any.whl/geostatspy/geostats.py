...
def regular_sample(array,array2,xmin,xmax,ymin,ymax,spacing,minsx,maxsx,minsy,maxsy,name='Value',name2='Value2'):
    if minsx > 0: 
        minsx=xmin
    if maxsx > 0: 
        maxsx=xmax
...
def random_sample(array,array2,xmin,xmax,ymin,ymax,nsamp,minsx,maxsx,minsy,maxsy,name='Value',name2='Value2'):
    if minsx < 0:
        minsx = xmin     
    if maxsx < 0:
        maxsx = xmax
