...
class TestBuildStructuredPrefix(unittest.TestCase):
    ...
    def test_narrator_injection(self):
        ...
        structured_prefix = StructuredPrefix(
            ...
            hermes_generation_template_name=os.path.join(
                HERE, "templates", "production.yml.j2"
            ),
        )
    ...
    def test_audio_mode_instruction(self):
        ...
        structured_prefix = StructuredPrefix(
            ...
            chat_history=[],
            hermes_generation_template_name=os.path.join(
                HERE, "templates", "production_raw.yml.j2"
            ),
    ...
    def test_production_template_parity(self):
        ...
        template_names = [os.path.join(HERE, "templates", "production_raw.yml.j2")]
    ...
    def test_names(self):
        ...
        base_structured_prefix.hermes_generation_template_name = os.path.join(
            HERE, "templates", "production.yml.j2"
        )
        _ = build_structured_prefix(
            self.mock_logger, base_structured_prefix, truncation_step=1
