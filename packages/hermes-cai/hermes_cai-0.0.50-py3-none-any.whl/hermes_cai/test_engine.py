...
class TestBuildStructuredPrefix(unittest.TestCase):
    ...
    def test_narrator_injection(self):
        ...
        structured_prefix = StructuredPrefix(
            ...
            hermes_generation_template_name="./templates/production.yml.j2",
        )
    ...
    def test_audio_mode_instruction(self):
        ...
        structured_prefix = StructuredPrefix(
            ...
            chat_history=[],
            hermes_generation_template_name="./templates/production_raw.yml.j2",
    ...
    def test_raw_prompt_data(self):
        ...
        structured_prefix = StructuredPrefix(
            ...
            reply_prompt="Balderdash:",
            hermes_generation_template_name="./templates/test.yml.j2",
            timestamp="2024 04 23 Tuesday 19 07",
            raw_prompt_data_str="""{
                "chat_type": "ONE_ON_ONE",
                "character": {
    ...
    def test_production_template_parity(self):
        ...
        template_names = ["./templates/production_raw.yml.j2"]
    ...
    def test_names(self):
        ...
        base_structured_prefix.hermes_generation_template_name = (
            "./templates/production.yml.j2"
        )
        _ = build_structured_prefix(
            self.mock_logger, base_structured_prefix, truncation_step=1
        )
