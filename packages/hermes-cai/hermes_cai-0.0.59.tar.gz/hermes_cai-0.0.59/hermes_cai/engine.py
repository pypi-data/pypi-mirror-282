...
from prompt_poet import AbstractTokenizer, Prompt, PromptPart, Template
...
class MonitoredTemplate(Template):
    """Monitored Template."""

    @monitor
    def __init__(self, *args, **kwargs):
        """Initialize the monitored template."""
        super().__init__(*args, **kwargs)
    ...
    def _load_template(self, *args, **kwargs):
        return super()._load_template(*args, **kwargs)


import prompt_poet

prompt_poet.Template = MonitoredTemplate
