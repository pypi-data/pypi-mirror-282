...
class CreateCustomerRequest(BaseModel):
  ...
  # noqa: E501
  first_name: StrictStr = Field(description='The customer’s first name or Business Name.')
  last_name: StrictStr = Field(description='The customer’s last name or Entity Type.')
