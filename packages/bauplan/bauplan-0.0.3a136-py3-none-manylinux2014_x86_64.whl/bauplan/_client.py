...
from . import _common, _query, exceptions
from ._import import ApplyPlanState, PlanImportState, _apply, _plan
...
class Client:
    """
    A consistent interface for authenticated access to Bauplan operations.

    Catalog operations raise a subclass of bauplan.exceptions.BauplanError that mirror HTTP status codes:
    ...
    Run/Query/Scan operations raise a subclass of bauplan.exceptions.BauplanError that represents, and also return a RunState object containing details and logs:
        RunError e.g. indicates a broken gRPC link, via grpc._channel._InactiveRpcError
    ...
    def query(
        ...
        :param branch_name: The branch to read from (default: your local active branch or 'main').
    ...
    def query_to_generator(
        ...
        """
        try:
            return _query._query_to_generator(
                api_key=self._api_key,
                query=query,
                max_rows=max_rows,
                no_cache=no_cache,
            ...
            if e.args:
                raise exceptions.RunError(e.args[0]) from e
    ...
    def get_branches(
        ...
        for record in _common._paginate_api(
            self._api_key, path, limit=limit, itersize=itersize, params=params
        ):
    ...
    def get_branch(
        ...
        for record in _common._paginate_api(
            self._api_key, f'/v0/refs/{branch_name}/tables', limit=limit, itersize=itersize
        ):
    ...
    def get_branch_metadata(self, branch_name: str) -> Ref:
        ...
        out: APIResponse = _common._make_api_call(self._api_key, 'get', f'/v0/refs/{branch_name}')
    ...
    def merge_branch(self, onto_branch: str, from_ref: str) -> bool:
        ...
        """
        _common._make_api_call(self._api_key, 'post', f'/v0/refs/{from_ref}/merge/{onto_branch}')
        return True
    ...
    def create_branch(self, branch_name: str, from_ref: str) -> APIBranch:
        ...
        out: APIResponse = _common._make_api_call(self._api_key, 'post', '/v0/branches', body=body)
    ...
    def delete_branch(self, branch_name: str) -> bool:
        ...
        """
        _common._make_api_call(self._api_key, 'delete', f'/v0/branches/{branch_name}')
        return True
    ...
    def get_table_with_metadata(
        ...
        out: APIResponse = _common._make_api_call(
            self._api_key, 'get', f'/v0/refs/{branch_name}/tables/{table_name}', params=params
        )
    ...
    def get_table(self, branch_name: str, table_name: str) -> List[TableField]:
        ...
        out: APIResponse = _common._make_api_call(
            self._api_key, 'get', f'/v0/refs/{branch_name}/tables/{table_name}'
        )
    ...
    def drop_table(self, table_name: str, branch_name: str) -> bool:
        ...
        """
        _common._make_api_call(self._api_key, 'delete', f'/v0/branches/{branch_name}/tables/{table_name}')
        return True
    ...
    def plan_import(self, search_string: str, args: Optional[Dict] | None = None) -> PlanImportState:
        ...
        """
        try:
            return _plan(search_string=search_string, args=args, api_key=self._api_key)
        except grpc._channel._InactiveRpcError as e:
            if e.args:
                raise exceptions.RunError(e.args[0]) from e
            raise exceptions.RunError(e) from e
    ...
    def _api_key(self) -> str:
        """
        Helper to get the API key from the client instance, the env, or the config.
        :meta private:
        """
        return _common._get_api_key(self._private_api_key)
