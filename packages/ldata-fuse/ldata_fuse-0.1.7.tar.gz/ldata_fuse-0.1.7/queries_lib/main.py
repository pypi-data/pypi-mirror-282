...
from queries_lib.schema import String, Int, Float, Boolean, ID, BigInt, BigFloat, Cursor, Datetime, JwtToken, Base64EncodedBinary, JSON, LdataNodeType, LdataNodesOrderBy, PermLevel, LdataDataCreator, TeamRole, DatasetAvailability, DatasetDownloadStatus, LdataEventType, LdataWfExStatus, ExecutionNodeStatus, ExecutionStatus, PodBackupStatus, LdataTagType, LdataTreeEdgesOrderBy, LdataObjectMetasOrderBy, AccountInfosOrderBy, DatasetDownloadInfosOrderBy, DatasetInfoTagsOrderBy, DatasetPurchasesOrderBy, DatasetRequestsOrderBy, LdataNodeEventsOrderBy, WorkflowGraphNodeType, WorkflowGraphNodesOrderBy, WorkflowGraphBranchType, WorkflowGraphBranchesOrderBy, TaskExecutionStatus, ContainerInfosOrderBy, TaskExecutionInfosOrderBy, ExecutionGraphNodesOrderBy, WorkflowGraphEdgesOrderBy, WorkflowSubscriptionsOrderBy, ExecutionInfosOrderBy, LpInfosOrderBy, WorkflowTagsOrderBy, AutomationVersionsOrderBy, AutomationRunLdataEventsOrderBy, AutomationTriggerLdataEventsOrderBy, AutomationRunIntervalEventsOrderBy, AutomationTriggerIntervalEventsOrderBy, WorkflowInfosOrderBy, TaskExecutionMessagesOrderBy, SnakemakeExecutionInfosOrderBy, NfProcessEdgesOrderBy, NfTaskExecutionInfosOrderBy, NfTaskInfosOrderBy, NfProcessNodesOrderBy, NotificationStatus, ExecutionBatchMembersOrderBy, NotificationType, ExecutionNotificationInfosOrderBy, IgvGenomesOrderBy, LdataWfExesOrderBy, LdataLinkDataOrderBy, LdataShareInvitesOrderBy, LdataSharePermissionsOrderBy, LdataNodeTagsOrderBy, IgvTracksOrderBy, CatalogEventType, CatalogEventsOrderBy, CatalogSampleColumnDataOrderBy, CatalogExperimentsOrderBy, BenchlingImportsOrderBy, CatalogExperimentColumnDefinitionsOrderBy, CatalogSamplesOrderBy, CatalogExperimentViewsOrderBy, PlotInfosOrderBy, PlotTransformInfosOrderBy, PlotTransformSourceCodesOrderBy, PlotTransformExecutionsOrderBy, PlotNotebookCheckpointInfosOrderBy, PlotNotebookCrdtUpdatesOrderBy, PlotCellValueViewersOrderBy, PlotNotebookTemplateVersionsOrderBy, PlotNotebookTemplateSubscriptionsOrderBy, PlotDataSourceInfosOrderBy, TaskInfosOrderBy, ExecutionCreatorsOrderBy, LdataS3MountAccessProvensOrderBy, LdataS3MountConfiguratorRolesOrderBy, CreditsOrderBy, TeamInfosOrderBy, OrgMembersOrderBy, OrgInvitesOrderBy, TeamInvitesOrderBy, TeamMembersOrderBy, LdataShareLinkNodesOrderBy, PodStatus, InstanceSize, PodInfosOrderBy, PodTemplateVersionsOrderBy, PodTemplateSubscriptionsOrderBy, PodSessionEventsOrderBy, PodSessionsOrderBy, EbsSessionsOrderBy, PodBackupsOrderBy, PublicKeyInfosOrderBy, BasespaceApiTokensOrderBy, WorkflowPinsOrderBy, AccountAccessPoliciesOrderBy, CatalogProjectsOrderBy, AccountSecretsOrderBy, PodTemplatesOrderBy, ExecutionBatchInfosOrderBy, VerifiedEmailsOrderBy, PodGroupInfosOrderBy, AutomationInfosOrderBy, PlotLayoutInfosOrderBy, BenchlingImportRunsOrderBy, NextflowTaskType, NextflowNodeInfosOrderBy, PlotNotebookInfosOrderBy, LdataGoogleVerifiedBucketsOrderBy, LdataGoogleVerifiedProjectsOrderBy, PlotNotebookTemplateFamiliesOrderBy, WorkflowPersonalizationsOrderBy, OrgInfosOrderBy, AccountCreditLimitsOrderBy, BenchlingApiTokensOrderBy, DatasetAgreementActivatedsOrderBy, DatasetInfosOrderBy, ExecutionRefLpInfosOrderBy, GithubPersonalAccessTokensOrderBy, IncidentInfosOrderBy, IntegrationsGoogleAuthsOrderBy, LdataNodeEventChildRemovesOrderBy, LdataNodeEventIngressesOrderBy, LdataNodeEventMovesOrderBy, LdataNodeEventRemovesOrderBy, LdataS3MountRolesOrderBy, PlotTransformTemplateInfosOrderBy, PlotWhitelistsOrderBy, SharingReceiverSharedDataTypesOrderBy, StripeSubscriptionInfosOrderBy, TaskExecutionRuntimeInfosOrderBy, UserInfosOrderBy, UserInfoSharedDataTypesOrderBy, WorkflowFamilyInfosOrderBy, WorkflowGraphSubWfsOrderBy, WorkflowPreviewsOrderBy, WorkspaceInviteLinksOrderBy, AutomationTriggerType
...
query_str_l_data_subtree_by_path_query = query_str_node_info_fragment + "query LDataSubtreeByPath($path:String!){ldataResolvePathData(argPath:$path){id childLdataTreeEdges(filter:{child: {removed: {equalTo: False},pending: {equalTo: False}}},orderBy:LDATA_NODE_BY_CHILD_ID__NAME_ASC){nodes{child{...NodeInfo finalLinkTarget{...NodeInfo}}}}}}"
