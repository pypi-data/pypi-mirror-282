...
def generate_AbInitioThermodynamics(path: str, source: str = None, forces_tag:str=None, energy_tag:str=None, subfolders: bool = False, output_path: str = None, 
    ...
    if plot.upper() in ['PHASE_DIAGRAM', 
                        ...
                        'GLOBAL_LINEAR',
                        'CLUSTER_ANALYSIS',
                        'COMPOSITION_ENERGY_CORRELATION',
                        'ENERGY_LANDSCAPE',
...
def main():
    ...
    parser_AbIT.add_argument('--plot', type=str, choices=['phase_diagram', 'local_linear', 'global_linear', 'F', 'cluster_analysis', 'composition_energy_correlation', 'energy_landscape', 'thermodynamic_stability'], help='')
    ...
    parser_AbIT.add_argument('--opt', default=False, action='store_true', help='')
    ...
    if args.command == 'export':
        ...
        generate_AbInitioThermodynamics(path=args.path,     source=args.source,     forces_tag=args.forces_tag,     energy_tag=args.energy_tag,      subfolders=args.subfolders, 
                                        index=args.index,   verbose=args.verbose,   output_path=args.output_path,   output_source=args.output_source, 
                                        plot=args.plot, k=args.k, opt=args.opt,
