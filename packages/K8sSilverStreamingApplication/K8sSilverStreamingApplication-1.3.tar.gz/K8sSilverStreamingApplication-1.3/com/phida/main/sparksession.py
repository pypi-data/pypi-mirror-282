...
def create_spark_session(appName, tenant_id, client_id, client_secret, ssa_storage_accounts):
...
spark = create_spark_session(appName, tenant_id, client_id, client_secret, ssa_storage_accounts)
