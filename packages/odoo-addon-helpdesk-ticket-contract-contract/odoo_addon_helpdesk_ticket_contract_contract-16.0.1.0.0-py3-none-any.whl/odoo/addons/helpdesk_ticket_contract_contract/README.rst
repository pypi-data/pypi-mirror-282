...
- You will be allowed to assign a contract to a ticket, being only available those of the same ticket's partner.
...
- From the form view of a contract, their related tickets will be accessible through a smart button, as it works with their partners.
