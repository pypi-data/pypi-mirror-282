...
def pdf_to_word(pdf_path: str, output_dir: str, lang="fas+eng", **kwargs):
    ...
    pages = convert_from_path(pdf_path,poppler_path=f"{parent_path}/my_pkg/resources/poppler-24.02/bin")

    pytesseract.pytesseract.tesseract_cmd = f"{parent_path}/my_pkg/resources/Tesseract-OCR/tesseract.exe"
    texts = []
