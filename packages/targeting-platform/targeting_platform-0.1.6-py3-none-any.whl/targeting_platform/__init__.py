...
Then you have implementation for each platfrom we support. Not all interfaces will be implemented in specific classes as not supported, e.g. The Trade Dest does not have clone and delete for Ad Groups.
"""
