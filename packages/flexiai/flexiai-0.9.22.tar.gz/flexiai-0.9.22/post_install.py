...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Post-installation script for FlexiAI.")
    parser.add_argument('project_root', type=str, help='The root directory of the project.')
    args = parser.parse_args()

    try:
        create_logs_folder(args.project_root)
        create_user_flexiai_rag_folder(args.project_root)
        create_env_file(args.project_root)
