...
class PostInstallCommand(install):
    ...
    def create_user_flexiai_rag_folder(self, project_root):
        ...
        """
        src_folder = os.path.join(project_root, 'flexiai', 'user_flexiai_rag')
    ...
    def copy_env_template(self, project_root):
        ...
        Args:
            project_root (str): The root directory of the project.
        """
        src_file = os.path.join(project_root, '.env.template')
    ...
    def copy_requirements(self, project_root):
        ...
        Args:
            project_root (str): The root directory of the project.
        """
        src_file = os.path.join(project_root, 'requirements.txt')
...
#     def run(self):
#         install.run(self)
#         self.create_user_flexiai_rag_folder()
#         self.copy_env_template()
#         self.copy_requirements()

#     def create_user_flexiai_rag_folder(self):
...
#         dst_file = os.path.join(os.path.expanduser("~"), '.env.template')
#         self.copy_file(src_file, dst_file)
