...
setup(
    name='flexiai',
    version='0.8.0',
    packages=find_packages(include=['assistant', 'config', 'core', 'core.utils', 'docs', 'examples', 'logs', 'tests', 'user_flexiai_rag']),
    include_package_data=True,
    package_data={
        'user_flexiai_rag': ['data/*.csv', '*.py'],
    },
    install_requires=[
    ...
    description='A flexible AI framework for managing OpenAI and Azure interactions, with Retrieval-Augmented Generation capabilities.',
