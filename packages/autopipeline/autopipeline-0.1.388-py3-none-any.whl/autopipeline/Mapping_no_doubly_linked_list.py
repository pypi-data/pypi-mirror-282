...
def schema_gpt_tree(user_query, column_description, description, function_chain, function_list, verbose, client, gpt4, udf = None):
    tree = {
        ...
        "chatter": [
            {
                ...
                "description": 
                ''' 
                This function takes in one of the columns of texts as input, generates the defense against the texts in that column, and generate an additional column to include those.
                ''',
                "parameters": {
                    "type": "object",
                    "properties": {"column": {
        ...
        "continuous_calculator": [
            {
                ...
                "description": 
                ''' 
                This function takes in one of the columns of texts as input, calculates the (numerical) informative score of the texts, and generate an additional column to include those.
                ''',
                "parameters": {
                    "type": "object",
                    "properties": {"column": {
        ...
        "multiple_classifier": [
            ...
            {
                "name": "get_emotion",
                "description": "This function takes in one of the columns as input, applies emotion classification on the content of that column, and generates an additional column labeling the content with its emotion class (sad, joy, angry, etc).",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "column": {
