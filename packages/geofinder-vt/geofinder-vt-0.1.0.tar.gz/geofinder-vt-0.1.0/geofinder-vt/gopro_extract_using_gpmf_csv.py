...
def extract_metadata(video_file=VIDEO_FILE, 
                    output_dir=None, 
    ...
    # using empty format=''
    log_filename = 'gopro_extract_using_gpmf_csv_' + video_file.replace('.','') + timestamp_str + '.log'
    ...
    try:
        ...
        logging.error(f"FileNotFoundError: {video_file} not found")
        return
