...
Properties = _reflection.GeneratedProtocolMessageType('Properties', (_message.Message,), {
  ...
  '__module__' : 'ansys.api.acp.v0.spherical_selection_rule_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.acp.v0.spherical_selection_rule.Properties)
  })
...
ObjectInfo = _reflection.GeneratedProtocolMessageType('ObjectInfo', (_message.Message,), {
  ...
  '__module__' : 'ansys.api.acp.v0.spherical_selection_rule_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.acp.v0.spherical_selection_rule.ObjectInfo)
  })
...
ListReply = _reflection.GeneratedProtocolMessageType('ListReply', (_message.Message,), {
  ...
  '__module__' : 'ansys.api.acp.v0.spherical_selection_rule_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.acp.v0.spherical_selection_rule.ListReply)
  })
...
CreateRequest = _reflection.GeneratedProtocolMessageType('CreateRequest', (_message.Message,), {
  ...
  '__module__' : 'ansys.api.acp.v0.spherical_selection_rule_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.acp.v0.spherical_selection_rule.CreateRequest)
  })
