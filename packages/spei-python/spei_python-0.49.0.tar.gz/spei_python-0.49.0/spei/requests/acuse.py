...
class AcuseRequest(object):
    def __new__(cls, tipo_respuesta: TipoRespuestaAcuse, acuses: List[Acuse] = (), as_string=True):  # noqa: E501
        respuesta_element = RespuestaElement(ReturnElement(MensajeElement(acuses, tipo_respuesta)))  # noqa: E501
