...
"""
    This is a collection of stacking algorithms for ambient noise cross-correlation.
    
    - From https://github.com/xtyangpsp/StackMaster
    - Modified by Fu Yin @Rice (May2023)

"""


def stacklib(d, method, par=None):
    """
