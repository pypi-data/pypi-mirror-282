...
# TODO remove this when we have our own SessionMiddleware,
# right now I am making it explicit that SessionMiddleware is to be exported
__all__ = ["SessionMiddleware", "get_current_username", "get_mongo_db", "BaseRabbit"]
...
class BaseRabbit:
    ...
    # Not needed right now, but these two functions should be more flexible to
