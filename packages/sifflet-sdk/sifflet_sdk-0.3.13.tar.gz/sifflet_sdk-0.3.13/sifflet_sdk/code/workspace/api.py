        ...
        try:
            ...
            if err.body:
                ...
                if error_body.get("type") == "sifflet:errors:workspace:apply":
                    ...
                    # doesn't deserialize nested objects without setting explicitely the Configuration
                    # https://stackoverflow.com/questions/72094871/openapi-python-generator-convert-from-dict-to-model
                    return WorkspaceApplyResponseDto(**response, _configuration=Configuration())
            raise err
        return response
