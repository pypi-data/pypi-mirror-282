...
class SecurityDBApi(object):
    ...
    def security_db_list_model_security_reports(self, **kwargs):  # noqa: E501
        """ListModelSecurityReports  # noqa: E501

        Returns all supply chain risk reports for the workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.security_db_list_model_security_reports(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.security_db_list_model_security_reports_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.security_db_list_model_security_reports_with_http_info(**kwargs)  # noqa: E501
            return data

    def security_db_list_model_security_reports_with_http_info(self, **kwargs):  # noqa: E501
        """ListModelSecurityReports  # noqa: E501

        Returns all supply chain risk reports for the workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.security_db_list_model_security_reports_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method security_db_list_model_security_reports" % key
                )
            params[key] = val
        del params['kwargs']
