...
class Registry:
    ...
    def register_and_validate_dataset(
        ...
        with RESTErrorHandler():
            ...
            res: RimeRegisterDatasetResponse = api.registry_service_register_dataset(
                body=req,
    ...
    def register_and_validate_model(
        ...
        with RESTErrorHandler():
            api = swagger_client.RegistryServiceApi(self._api_client)
            res: RimeRegisterModelResponse = api.registry_service_register_model(
                body=req,
                project_id_uuid=project_id,
            )
    ...
    def register_and_validate_predictions(
        ...
        with RESTErrorHandler():
            api = swagger_client.RegistryServiceApi(self._api_client)
            res: RimeRegisterPredictionSetResponse = (
                api.registry_service_register_prediction_set(
                    body=req,
                    project_id_uuid=project_id,
    ...
    def get_predictions(self, model_id: str, dataset_id: str) -> Dict:
        ...
        api = swagger_client.RegistryServiceApi(self._api_client)
        with RESTErrorHandler():
            res: RimeGetPredictionSetResponse = api.registry_service_get_prediction_set(
