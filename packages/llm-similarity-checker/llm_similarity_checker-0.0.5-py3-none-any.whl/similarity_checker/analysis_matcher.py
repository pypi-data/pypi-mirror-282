...
class AnalysisMatcher:
    def __init__(self, tokenizer_path="trained_models/bert_tokenizer.joblib", model_path="trained_models/bert_model.joblib"):
    ...
    def match(self, sentence1, sentence2, threshold=0.8):
