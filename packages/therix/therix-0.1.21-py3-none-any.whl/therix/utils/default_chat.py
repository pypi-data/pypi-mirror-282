...
async def async_invoke_default_chat(inference_model_details, session, pipeline_id, question, trace_details=None, system_prompt=None):
    chain_callbacks = []
...
def invoke_default_chat(inference_model_details, session, pipeline_id, question, trace_details=None, system_prompt=None):
    chain_callbacks = []
    if trace_details is not None:
        langfuse_handler = CallbackHandler(
            secret_key=trace_details["secret_key"],
