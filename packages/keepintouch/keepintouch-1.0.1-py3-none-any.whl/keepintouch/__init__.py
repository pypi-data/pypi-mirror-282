...
class Init(object):
    ...
    def update(self, key_string, value_string):
        return _update(request_headers=self.request_headers, key_string=key_string,value_string=value_string)

    def get(self, greeting_id=None):
        return _get(request_headers=self.request_headers, greeting_id=greeting_id)