...
class UnmappedMethod(object):
    ...
    async def run(self, *args, **kwargs):
        ...
        try:
            if self.kwargs.get('io_bound', True):
    ...
    async def run(self, *args, **kwargs):
        ...
        if result == 'Yes':
            ...
            for instance in selected_instances:
                ...
                try:
                    if kwargs.get('io_bound', True):
                        await run.io_bound(self.method, instance, *args, *self.args, **kwargs, **self.kwargs)
                    else:
                        self.method(*args, *self.args, instance, **kwargs, **self.kwargs)
