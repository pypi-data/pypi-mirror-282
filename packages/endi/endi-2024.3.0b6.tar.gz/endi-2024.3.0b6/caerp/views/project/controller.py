...
from caerp.forms.project import get_edit_project_schema, get_full_add_project_schema
...
class ProjectTreeController:
    ...
    def _collect_estimations(
        ...
        # Est appelé depuis collect_project
            ...
            query = query.join(Estimation.business).filter(
    ...
    def _collect_invoices(
        ...
        if business_id is not None:
            ...
            query = query.join(Estimation.business).filter(Business.visible == False)
    ...
    def _collect_project(
        ...
        # on collecte les affaires et leurs devis et factures
