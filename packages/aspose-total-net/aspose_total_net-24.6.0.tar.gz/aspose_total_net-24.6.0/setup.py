...
REQUIRES = ["aspose-3d==24.5.0",
            "aspose-barcode-for-python-via-net==24.6",
            "aspose-cad==24.6",
            "aspose-cells-python==24.6.0",
            "aspose-diagram-python==24.6",
            "Aspose.Email-for-Python-via-NET==24.6",
            "aspose-finance==24.5",
            "aspose-imaging-python-net==24.6.0",
            "aspose-ocr-python-net==24.6.0",
            "aspose-page==24.6.0",
            "aspose-pdf==24.6.0",
            "aspose-psd==24.4.0",
            "Aspose.Slides==24.6.0",
            "aspose-svg-net==24.6.0",
            "aspose-tasks==24.6.0",
