...
class HTTPStatus(Enum):
    ...
    ScoreThresh_TYPE_ERR = (400008, "请求体的参数字段类型错误", "ScoreThresh 字段应该是 list 类型") # 图片帧加跟踪去重
    ...
    SizeThresh_TYPE_ERR = (400008, "请求体的参数字段类型错误", "SizeThresh 字段应该是 list 类型")
    ...
    ScoreThresh_EMPTY_ERR = (400009, "请求体的参数字段值为空", "ScoreThresh 列表为空") # 图片帧加跟踪
    SizeThresh_EMPTY_ERR = (400009, "请求体的参数字段值为空", "SizeThresh 列表为空")
    AnalysisArea_EMPTY_ERR = (400009, "请求体的参数字段值为空", "AnalysisArea 列表为空")
