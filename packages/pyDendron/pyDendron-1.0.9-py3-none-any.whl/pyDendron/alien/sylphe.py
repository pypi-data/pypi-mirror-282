...
class Sylphe:
    ...
    def __init__(self, dbaccess='/Users/meignier/Dendro/dataset/sylphe/didier/SylpheDidier.mdb', get_place=False, places='location.p', reverse_places='reverse_location.p'):
        #self.path = path
        ...
        self.sequences_access = None
        self.indices_access = None
        self.components_access = None
    ...
    def import_access(self):
        try:
            ...
            #    df.to_csv(f'import_access{table}.csv', index=False)
    ...
    def read_sequences(self) :
        ...
        sequences = self.sequences_access[sylphe_col_sequences.keys()]
    ...
    def read_indices(self):
        ...
        indices = self.indices_access[sylphe_col_indices.keys()]
    ...
    def read_components(self):
        ...
        components = self.components_access[sylphe_col_components.keys()]
