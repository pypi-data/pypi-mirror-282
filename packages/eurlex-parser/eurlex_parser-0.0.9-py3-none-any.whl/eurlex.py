...
from src.utils import extract_directives_and_regulations
from src.utils import extract_directive_and_regulation_at_beginning
import pandas as pd
import warnings
...
print(get_data_by_celex_id("32016R0679"))