...
class CompanyHeaderController(FileController):
    def get_schema(self, submitted: Optional[dict] = None):
        return CompanyHeaderSchema()


class CompanyHeaderRestView(FileRestView):
    controller_class = CompanyHeaderController
