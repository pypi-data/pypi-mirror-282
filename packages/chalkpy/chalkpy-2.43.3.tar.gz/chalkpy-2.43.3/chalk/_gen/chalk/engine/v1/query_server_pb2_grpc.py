...
class QueryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.QueryFromPlan = channel.unary_unary(
            "/chalk.engine.v1.QueryService/QueryFromPlan",
            request_serializer=chalk_dot_engine_dot_v1_dot_query__server__pb2.QueryFromPlanRequest.SerializeToString,
            response_deserializer=chalk_dot_engine_dot_v1_dot_query__server__pb2.QueryFromPlanResponse.FromString,
        )
...
class QueryServiceServicer(object):
    ...
    def QueryFromPlan(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_QueryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "QueryFromPlan": grpc.unary_unary_rpc_method_handler(
            servicer.QueryFromPlan,
            request_deserializer=chalk_dot_engine_dot_v1_dot_query__server__pb2.QueryFromPlanRequest.FromString,
            response_serializer=chalk_dot_engine_dot_v1_dot_query__server__pb2.QueryFromPlanResponse.SerializeToString,
        ),
    }
...
class QueryService(object):
    ...
    def QueryFromPlan(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/chalk.engine.v1.QueryService/QueryFromPlan",
            chalk_dot_engine_dot_v1_dot_query__server__pb2.QueryFromPlanRequest.SerializeToString,
            chalk_dot_engine_dot_v1_dot_query__server__pb2.QueryFromPlanResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
