...
import _h2o_mlops_client.external_registry.models
from _h2o_mlops_client.external_registry import rest
from _h2o_mlops_client.external_registry.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(_h2o_mlops_client.external_registry.models, klass)
