...
class Vault:
    def __init__(self, user: str = None, api_key: str = None, openai_key: str = None, vault: str = None, embeddings_model: str = None, verbose: bool = False, conversation_user_id: str = None, groq_api: str = None, chat_ai: str = 'openai'):
        ''' 
        ...
        self.tools = ToolsGPT(verbose=verbose, ai=chat_ai)
