...
class ReactAggregateResponseContent(object):
    ...
    openapi_types = {
        ...
        'feature_contribution_full': 'float',
        'feature_contribution_robust': 'float',
        'mae': 'float',
    ...
    attribute_map = {
        ...
        'feature_contribution_full': 'feature_contribution_full',
        'feature_contribution_robust': 'feature_contribution_robust',
        'mae': 'mae',
    ...
    nullable_attributes = [
        'accuracy', 
        'confusion_matrix', 
        'feature_contribution_full', 
        'feature_contribution_robust', 
        'mae', 
    ...
    def __init__(self, accuracy=None, confusion_matrix=None, feature_contribution_full=None, feature_contribution_robust=None, mae=None, feature_residuals_full=None, feature_residuals_robust=None, feature_mda_full=None, feature_mda_robust=None, feature_mda_permutation_full=None, feature_mda_permutation_robust=None, precision=None, r2=None, recall=None, missing_value_accuracy=None, rmse=None, spearman_coeff=None, mcc=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._feature_contribution_full = None
        self._feature_contribution_robust = None
        self._mae = None
        ...
        self.feature_contribution_full = feature_contribution_full
        self.feature_contribution_robust = feature_contribution_robust
        self.mae = mae
    ...
    @property
    def feature_contribution_full(self):
        """Get the feature_contribution_full of this ReactAggregateResponseContent.

        The full contribution to the predicted value of an action feature. 

        :return: The feature_contribution_full of this ReactAggregateResponseContent.
        :rtype: float
        """
        return self._feature_contribution_full

    @feature_contribution_full.setter
    def feature_contribution_full(self, feature_contribution_full):
        """Set the feature_contribution_full of this ReactAggregateResponseContent.

        The full contribution to the predicted value of an action feature. 

        :param feature_contribution_full: The feature_contribution_full of this ReactAggregateResponseContent.
        :type feature_contribution_full: float
        """

        self._feature_contribution_full = feature_contribution_full

    @property
    def feature_contribution_robust(self):
        """Get the feature_contribution_robust of this ReactAggregateResponseContent.

        The robust contribution to the predicted value of an action feature. 

        :return: The feature_contribution_robust of this ReactAggregateResponseContent.
        :rtype: float
        """
        return self._feature_contribution_robust

    @feature_contribution_robust.setter
    def feature_contribution_robust(self, feature_contribution_robust):
        """Set the feature_contribution_robust of this ReactAggregateResponseContent.

        The robust contribution to the predicted value of an action feature. 

        :param feature_contribution_robust: The feature_contribution_robust of this ReactAggregateResponseContent.
        :type feature_contribution_robust: float
        """

        self._feature_contribution_robust = feature_contribution_robust
