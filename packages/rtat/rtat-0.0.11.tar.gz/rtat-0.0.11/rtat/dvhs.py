...
#        return None
    ...
    try:
        ...
        experiment_dir = os.path.join(temp_dir, experiment_id, 'SCANS', scan_id, resType)
       ...
       for structure, value in dis.items():
        for di, divalue in value.items():
            if di.startswith('D'):
                ...
                print("wrong dosimetric index ", di)
                continue
...
def save_dvh_to_csv(dvh_data, experiment_id,scan_id):
    output_dir=os.path.join(temp_dir,experiment_id,"SCANS",scan_id,"dvhs")
