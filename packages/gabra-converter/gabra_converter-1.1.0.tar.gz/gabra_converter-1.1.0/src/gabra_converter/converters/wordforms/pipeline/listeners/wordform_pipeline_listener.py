'''
Listen for events while a wordform pipeline is in progress.
'''
...
#########################################
class WordformPipelineListener(ABC):
    '''
    Abstract class to be inherited by wordform pipeline listeners.
    '''
