...
# 日志相关的配置
log_directory = os.environ.get("log_directory", default="/var/log/dde_agent")
log_file = os.environ.get("log_file", default="app.log")
...
log_store = os.environ.get("log_store", default="agent-dev")

# 大模型调用来源，当前source为服务名，eg core
source = os.environ.get("source")

# 大模型调用限流次数，eg 15
llm_limit = os.environ.get("llm_limit")
...
# 日志上传oss
oss_path_pre = os.environ.get("oss_path_pre")
