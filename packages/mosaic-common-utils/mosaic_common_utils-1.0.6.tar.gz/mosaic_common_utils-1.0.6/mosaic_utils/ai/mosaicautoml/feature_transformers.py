...
class CategoricalSelector(BaseEstimator, TransformerMixin):
    """
    Meta-transformer for selecting categorical features.

    It selects features and transform them using OneHotEncoder.
...
class ContinuousSelector(BaseEstimator, TransformerMixin):
    """Transformer for selecting continuous features and transform them using PCA.
