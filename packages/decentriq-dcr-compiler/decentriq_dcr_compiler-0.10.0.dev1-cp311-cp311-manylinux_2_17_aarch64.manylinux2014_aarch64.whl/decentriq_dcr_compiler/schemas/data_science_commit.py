...
class ExportConnectorKind2(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ExportConnectorKind4(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ExportConnectorKind5(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    dv360: Dv360Config
...
class ImportConnectorKind2(ExportConnectorKind2):
    pass


class ImportConnectorKind3(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    gcs: GcsConfig
...
class ExportConnectorKind3(ImportConnectorKind3):
    pass


class ExportConnectorKind(
    RootModel[
        Union[
            ExportConnectorKind1,
            ExportConnectorKind2,
            ExportConnectorKind3,
            ExportConnectorKind4,
            ExportConnectorKind5,
        ]
    ]
):
    root: Union[
...
class ImportConnectorKind4(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ImportConnectorKind(
    RootModel[
        Union[
            ImportConnectorKind1,
            ImportConnectorKind2,
            ImportConnectorKind3,
            ImportConnectorKind4,
        ]
    ]
):
    root: Union[
