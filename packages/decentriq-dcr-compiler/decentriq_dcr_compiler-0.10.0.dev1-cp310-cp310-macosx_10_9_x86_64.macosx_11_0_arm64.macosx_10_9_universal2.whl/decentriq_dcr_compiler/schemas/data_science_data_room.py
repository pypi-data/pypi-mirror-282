...
class AdManagerConfig(BaseModel):
    bucket: str
    identifierKind: str
...
class ExportConnectorKind8(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ExportConnectorKind10(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ExportConnectorKind11(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    dv360: Dv360Config
...
class ImportConnectorKind7(ExportConnectorKind8):
    pass


class ImportConnectorKind8(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    gcs: GcsConfig
...
class ExportConnectorKind9(ImportConnectorKind8):
    pass


class ExportConnectorKind6(
    RootModel[
        Union[
            ExportConnectorKind,
            ExportConnectorKind8,
            ExportConnectorKind9,
            ExportConnectorKind10,
            ExportConnectorKind11,
        ]
    ]
):
    root: Union[
...
class ImportConnectorKind9(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ImportConnectorKind5(
    RootModel[
        Union[
            ImportConnectorKind,
            ImportConnectorKind7,
            ImportConnectorKind8,
            ImportConnectorKind9,
        ]
    ]
):
    root: Union[
