...
@Description   :
"""
from typing import List, Union, Optional, Sequence, Literal, Tuple, Any
import numpy as np

from ..plugin import paddle, torch, PTensor, TTensor, Tensor
from ..metric import Metric
from ..registry import METRIC
from ..misc import check_input_dim, list2ndarray, average_precision_check_input_dim, check_input_type, \
    numpy_round2list, torch_round2list, paddle_round2list
