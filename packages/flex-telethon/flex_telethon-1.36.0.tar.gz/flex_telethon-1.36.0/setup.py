...
def main(argv):
    if len(argv) >= 2 and argv[1] in ('gen', 'clean'):
        ...
        setup(
            name='flex-telethon',
            version=version,
            description="Custom telethon fork for Flexbot",
            long_description=long_description,

            url='https://github.com/FlexbotUB/Telethon',
            download_url='https://github.com/FlexbotUB/Telethon/releases',

            author='Lonami Exo',
            author_email='asnct@disr.it',
