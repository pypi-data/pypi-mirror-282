...
# from .utils import geometry2shapely, get_polygon_bounds
...
class NUTSfinder:
    ...
    **Note**: Points-in-polyon tests via `shapely` may suffer from floating-point precision issues for points on the boundary of regions.
    ...
    # def _find_rtree_bbox(self, lon_min, lat_min, lon_max, lat_max, *args):
    #     """Find rectangle's regions fast using a R-tree."""
    ...
    def _candidates_rtree_old(self, lon, lat, regions):
    ...
    def _validate_candidate_set(self, lon, lat, hits):
        ...
        for region in max_levels:
            # TODO: can parents not be found if max level is found?
