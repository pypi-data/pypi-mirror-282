...
def read_objdump_x86_assembler(function_name:str, assembler:str):
    """Get X86 instructions of a function. Assembler must be objdump generated string.
...
def read_objdump_arm_assembler(function_name:str, assembler:str):
    """Get ARM instructions of a function. Assembler must be objdump generated string.
