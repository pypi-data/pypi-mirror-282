  ...
  def initMeasurementProtocol(self) -> None:
    ...
    if self.meastype.lower() == PBHC:  
      info_dict_sample = {"sample_thickness": (self.sample_thickness, "m"), 
                          ...
                          "Bx_air_area": (4.841419400266729e-06+self.sample_thickness*(self.drill_diameter-1e-3), "m^2"),
                          "By_air_area": (4.401017506887243e-06+self.sample_thickness*(self.drill_diameter-1e-3), "m^2")}
