...
class LimitOffsetPageEmployeeRoleToolSchema(BaseModel):
    """
    LimitOffsetPageEmployeeRoleToolSchema
    """ # noqa: E501
    items: List[EmployeeRoleToolSchema]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [EmployeeRoleToolSchema.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
