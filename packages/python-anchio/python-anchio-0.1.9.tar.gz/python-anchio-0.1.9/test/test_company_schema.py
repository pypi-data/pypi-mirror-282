...
class TestCompanySchema(unittest.TestCase):
    """CompanySchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanySchema:
        """Test CompanySchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanySchema`
        """
        model = CompanySchema()
        if include_optional:
