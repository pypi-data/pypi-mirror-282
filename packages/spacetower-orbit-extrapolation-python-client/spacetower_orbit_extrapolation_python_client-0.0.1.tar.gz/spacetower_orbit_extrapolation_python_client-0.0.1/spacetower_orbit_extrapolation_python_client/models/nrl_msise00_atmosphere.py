...
class NrlMsise00Atmosphere(AtmosphereModel):
    ...
    earth_fixed_frame: Optional[EarthFixedFrameIdentifier] = Field(default=None, alias="earthFixedFrame")
    ellipsoid_identifier: Optional[EllipsoidIdentifier] = Field(default=None, alias="ellipsoidIdentifier")
