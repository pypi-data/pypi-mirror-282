...
class EphemerisGenerationRequest(BaseModel):
    ...
    """ # noqa: E501
    ephemeris_type: Optional[EphemerisType] = Field(default=None, alias="ephemerisType")
    step: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ephemeris step. Units [s]")
    start_date: Optional[datetime] = Field(default=None, description="The start date (UTC) of the ephemeris generation interval", alias="startDate")
    end_date: Optional[datetime] = Field(default=None, description="The end date (UTC) of the ephemeris generation interval", alias="endDate")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ATTITUDE': 'AttitudeEphemerisRequest','BATTERY_POWER': 'BatteryPowerEphemerisRequest','GEODETIC': 'GeodeticEphemerisRequest','MASS': 'MassEphemerisRequest','MEAN_ORBIT': 'MeanOrbitEphemerisRequest','ORBIT_COVARIANCE': 'OrbitCovarianceRequest','OSCULATING_ORBIT': 'OsculatingOrbitEphemerisRequest','POSITION_VELOCITY': 'PositionVelocityEphemerisRequest','POSITION_VELOCITY_COVARIANCE': 'PositionVelocityCovarianceEphemerisRequest'
    }
