...
class StationEventRequest(BaseModel):
    ...
    """ # noqa: E501
    minimum_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=60.0, description="Minimum duration of passes to consider (a value unrealistically small would lower computational performance). Units [s]", alias="minimumDuration")
    ground_stations: Optional[List[GroundStation]] = Field(default=None, alias="groundStations")
    __properties: ClassVar[List[str]] = ["minimumDuration", "groundStations"]
