...
class AttitudeSequence(BaseModel):
    ...
    attitude_sequence_type: Optional[AttitudeSequenceType] = Field(default=AttitudeSequenceType.DATE_TRIGGERED_ATTITUDE_SWITCH, alias="attitudeSequenceType")
    initial_attitude_law: Optional[AttitudeLaw] = Field(default=None, alias="initialAttitudeLaw")
