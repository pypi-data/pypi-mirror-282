...
class DateTriggeredAttitudeSequence(AttitudeSequence):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attitudeSequenceType": obj.get("attitudeSequenceType") if obj.get("attitudeSequenceType") is not None else AttitudeSequenceType.DATE_TRIGGERED_ATTITUDE_SWITCH,
