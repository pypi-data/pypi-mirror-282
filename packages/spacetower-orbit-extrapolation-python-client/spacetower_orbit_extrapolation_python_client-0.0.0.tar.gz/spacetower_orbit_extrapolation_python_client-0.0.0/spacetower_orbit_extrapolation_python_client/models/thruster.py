...
class Thruster(BaseModel):
    ...
    """ # noqa: E501
    thrust: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Units [N]")
    specific_impulse: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Units [s]", alias="specificImpulse")
