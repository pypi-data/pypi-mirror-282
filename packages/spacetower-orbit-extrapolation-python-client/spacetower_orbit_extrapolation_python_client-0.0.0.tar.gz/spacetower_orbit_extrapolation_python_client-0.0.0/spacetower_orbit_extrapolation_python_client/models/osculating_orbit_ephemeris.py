...
class OsculatingOrbitEphemeris(BaseModel):
    ...
    """ # noqa: E501
    frame: Optional[InertialFrameIdentifier] = InertialFrameIdentifier.GCRF
    orbit_type: Optional[OrbitalParameterType] = Field(default=OrbitalParameterType.KEPLERIAN, alias="orbitType")
