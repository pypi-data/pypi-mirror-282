...
class QuaternionEphemeris(AttitudeEphemeris):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["frame", "attitudeRepresentationType", "dates", "data", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "frame": obj.get("frame") if obj.get("frame") is not None else InertialFrameIdentifier.GCRF,
