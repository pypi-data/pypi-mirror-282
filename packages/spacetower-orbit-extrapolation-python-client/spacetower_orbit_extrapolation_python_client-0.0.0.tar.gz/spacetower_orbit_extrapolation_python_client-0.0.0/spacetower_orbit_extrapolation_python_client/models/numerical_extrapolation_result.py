...
class NumericalExtrapolationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attitudeEphemeris", "batteryPowerEphemeris", "massEphemeris", "osculatingOrbitEphemeris", "meanOrbitEphemeris", "geodeticEphemeris", "positionVelocityEphemeris", "cartesianCovarianceEphemeris", "orbitalEventLogs", "stationEventLogs", "fieldOfViewEventLogs"]
