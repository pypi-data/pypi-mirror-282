    ...
    def make_instance(self, include_optional) -> BoxSpacecraft:
        ...
        if include_optional:
            return BoxSpacecraft(
                ...
                y_dimension = 1.337,
                z_dimension = 1.337,
                reflection_property_type = spacetower_orbit_extrapolation_python_client.models.solar_array.SolarArray(
                ...
                drag_property_type = spacetower_orbit_extrapolation_python_client.models.isotropic_drag_properties.IsotropicDragProperties(
