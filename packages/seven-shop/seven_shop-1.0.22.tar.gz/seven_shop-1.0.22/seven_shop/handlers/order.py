...
:LastEditTime: 2024-07-02 11:37:52
...
class RefundDetailHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        refund_model = OrderRefundModel().get_dict(where="refund_order_id = %s and shop_id = %s",params=[refund_order_id,shop_id],field="order_id,refund_order_id,refund_type,goods_refund_price,real_refund_price,postage,reason,status,add_time,pass_time,pass_remark,fail_remark")
        if not refund_model:
