...
from vllm.logging.batch_visualization import BatchVisualizer
...
class LLMEngine:
    ...
    def __init__(
        ...
        self.log_batch_visualization = log_batch_visualization
        ...
        self.batch_visualizer = BatchVisualizer(detokenizer=self.detokenizer)
    ...
    def from_engine_args(
        ...
        engine = cls(
            **engine_config.to_dict(),
            ...
            log_batch_visualization=engine_args.enable_log_batch_visualization,
    ...
    def step(self) -> List[Union[RequestOutput, EmbeddingRequestOutput]]:
        ...
        self.do_batch_visualization(scheduler_outputs=scheduler_outputs)
        ...
        self.do_batch_visualization_drop_requests(
            request_outputs=request_outputs)

        return request_outputs

    def do_batch_visualization(
        self,
        scheduler_outputs: Optional[SchedulerOutputs] = None,
    ) -> None:
        """Print the batch visualization"""

        if self.log_batch_visualization and scheduler_outputs:
            self.batch_visualizer.update_state(
                scheduled_seq_groups=scheduler_outputs.scheduled_seq_groups)
            self.batch_visualizer.render()

    def do_batch_visualization_drop_requests(
        self,
        request_outputs: Optional[List[Union[RequestOutput,
                                             EmbeddingRequestOutput]]] = None
    ) -> None:
        """Drop finished requests to prevent memory leak. This has to be
        split in two because the requests get edited by reference so we have 
        to log the batches before the forward pass"""

        if self.log_batch_visualization and request_outputs:
            self.batch_visualizer.drop_finished_requests(
                request_outputs=request_outputs)
