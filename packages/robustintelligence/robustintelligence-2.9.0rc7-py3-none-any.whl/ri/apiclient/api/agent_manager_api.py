...
from typing_extensions import Annotated
from ri.apiclient.models.agent_manager_request_firewall_instance_request import AgentManagerRequestFirewallInstanceRequest
...
class AgentManagerApi:
    ...
    @validate_call
    def agent_manager_create_agent(
        self,
        ...
        _param = self._agent_manager_create_agent_serialize(
            body=body,
        )
    ...
    def _agent_manager_create_agent_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def agent_manager_create_firewall_agent(
        self,
        name: Optional[str] = None,
        ...
        _param = self._agent_manager_create_firewall_agent_serialize(
            body=body,
        )
    ...
    def _agent_manager_create_firewall_agent_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def agent_manager_delete_agent(
        self,
        agent_id_uuid: str,
    ) -> object:
        """DeleteAgent
        ...
        _param = self._agent_manager_delete_agent_serialize(
    ...
    def _agent_manager_delete_agent_serialize(
        self,
        agent_id_uuid,
    ) -> RequestSerialized:
    ...
    def agent_manager_get_agent(
        ...
        _param = self._agent_manager_get_agent_serialize(
            agent_id_uuid=agent_id_uuid,
        )
    ...
    def _agent_manager_get_agent_serialize(
        self,
        agent_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def agent_manager_get_upgrade_for_agent(
        self,
        agent_id_uuid: str,
        agent_namespace: str,
        ...
        _param = self._agent_manager_get_upgrade_for_agent_serialize(
            agent_id_uuid=agent_id_uuid,
    ...
    def _agent_manager_get_upgrade_for_agent_serialize(
        self,
        agent_id_uuid,
        agent_namespace,
    ) -> RequestSerialized:
    ...
    def agent_manager_list_agents(
        ...
        _param = self._agent_manager_list_agents_serialize(
            page_size=page_size,
    ...
    def _agent_manager_list_agents_serialize(
        self,
        page_size,
        page_token,
    ...
    @validate_call
    def agent_manager_list_firewall_instances(
        self,
        page_size: Optional[str] = None,
        page_token: Optional[str] = None,
        first_page_query_agent_ids: Optional[List[str]] = None,
        ...
        :type page_token: str
        :param first_page_query_agent_ids: Specifies a set of agent IDs. The query filters for firewall instances that belong to the specified agents.
        :type first_page_query_agent_ids: List[str]
        ...
        _param = self._agent_manager_list_firewall_instances_serialize(
            page_size=page_size,
            page_token=page_token,
            first_page_query_agent_ids=first_page_query_agent_ids,
    ...
    def _agent_manager_list_firewall_instances_serialize(
        self,
        page_size,
        page_token,
        first_page_query_agent_ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/agents/firewall/instances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def agent_manager_request_firewall_instance(
        self,
        agent_id_uuid: str,
        ...
        body = AgentManagerRequestFirewallInstanceRequest(
          agent_id=agent_id,
          config=config,
        ...
        _param = self._agent_manager_request_firewall_instance_serialize(
            agent_id_uuid=agent_id_uuid,
            body=body,
        )
    ...
    def _agent_manager_request_firewall_instance_serialize(
        self,
        agent_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def agent_manager_upgrade_agent(
        self,
        agent_id_uuid: str,
        agent_id: Optional[object] = None,
        ...
        body = AgentManagerUpgradeAgentRequest(
          agent_id=agent_id,
          custom_values=custom_values,
        )

        _param = self._agent_manager_upgrade_agent_serialize(
            agent_id_uuid=agent_id_uuid,
            body=body,
        )
    ...
    def _agent_manager_upgrade_agent_serialize(
        self,
        agent_id_uuid,
        body,
    ) -> RequestSerialized:
