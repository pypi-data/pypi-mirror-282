...
class FileUploadApi:
    ...
    @validate_call
    def file_upload_delete_uploaded_file_url(
        self,
        uploaded_url: str,
    ) -> object:
        ...
        _param = self._file_upload_delete_uploaded_file_url_serialize(
    ...
    def _file_upload_delete_uploaded_file_url_serialize(
        self,
        uploaded_url,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_upload_list_uploaded_file_urls(
        self,
        ...
        _param = self._file_upload_list_uploaded_file_urls_serialize(
        )
    ...
    def _file_upload_list_uploaded_file_urls_serialize(
        self,
    ) -> RequestSerialized:
