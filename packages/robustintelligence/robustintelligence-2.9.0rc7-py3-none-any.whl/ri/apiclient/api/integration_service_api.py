...
class IntegrationServiceApi:
    ...
    @validate_call
    def integration_service_configure_integration(
        self,
        ...
        body = IntegrationServiceConfigureIntegrationRequest(
          integration_id=integration_id,
          variables=variables,
        )

        _param = self._integration_service_configure_integration_serialize(
    ...
    def _integration_service_configure_integration_serialize(
        self,
        integration_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def integration_service_create_integration(
        self,
        ...
        _param = self._integration_service_create_integration_serialize(
            body=body,
        )
    ...
    def _integration_service_create_integration_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def integration_service_delete_integration(
        self,
        integration_id_uuid: str,
    ) -> object:
        """DeleteIntegration
        ...
        _param = self._integration_service_delete_integration_serialize(
            integration_id_uuid=integration_id_uuid,
        )
    ...
    def _integration_service_delete_integration_serialize(
        self,
        integration_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def integration_service_get_integration(
        self,
        integration_id_uuid: str,
        ...
        _param = self._integration_service_get_integration_serialize(
            integration_id_uuid=integration_id_uuid,
        )
    ...
    def _integration_service_get_integration_serialize(
        self,
        integration_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def integration_service_list_workspace_integrations(
        self,
        ...
        _param = self._integration_service_list_workspace_integrations_serialize(
    ...
    def _integration_service_list_workspace_integrations_serialize(
        self,
        workspace_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def integration_service_update_integration(
        self,
        integration_id_uuid: str,
        ...
        :type integration_id_uuid: str
        :param integration:
        :type integration: IntegrationServiceUpdateIntegrationRequestIntegration
        :param mask:
        :type mask: str
        :return: Returns the result object.
        """ # noqa: E501

        body = IntegrationServiceUpdateIntegrationRequest(
          integration=integration,
          mask=mask,
        )

        _param = self._integration_service_update_integration_serialize(
            integration_id_uuid=integration_id_uuid,
            body=body,
        )
    ...
    def _integration_service_update_integration_serialize(
        self,
        integration_id_uuid,
        body,
    ) -> RequestSerialized:
