...
class WorkspaceServiceApi:
    ...
    @validate_call
    def workspace_service_add_users_to_workspace(
        self,
        ...
        body = WorkspaceServiceAddUsersToWorkspaceRequest(
          workspace_id=workspace_id,
          users=users,
        )

        _param = self._workspace_service_add_users_to_workspace_serialize(
    ...
    def _workspace_service_add_users_to_workspace_serialize(
        self,
        workspace_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_create_workspace(
        self,
        name: str,
        ...
        _param = self._workspace_service_create_workspace_serialize(
            body=body,
        )
    ...
    def _workspace_service_create_workspace_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_delete_workspace(
        self,
        workspace_id_uuid: str,
    ) -> object:
        """DeleteWorkspace
        ...
        _param = self._workspace_service_delete_workspace_serialize(
            workspace_id_uuid=workspace_id_uuid,
        )
    ...
    def _workspace_service_delete_workspace_serialize(
        self,
        workspace_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_get_workspace(
        self,
        workspace_id_uuid: str,
        ...
        _param = self._workspace_service_get_workspace_serialize(
            workspace_id_uuid=workspace_id_uuid,
        )
    ...
    def _workspace_service_get_workspace_serialize(
        self,
        workspace_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_list_project_tags_in_workspace(
        self,
        workspace_id_uuid: str,
        ...
        _param = self._workspace_service_list_project_tags_in_workspace_serialize(
            workspace_id_uuid=workspace_id_uuid,
        )
    ...
    def _workspace_service_list_project_tags_in_workspace_serialize(
        self,
        workspace_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_list_users_of_workspace(
        self,
        workspace_id_uuid: str,
        ...
        _param = self._workspace_service_list_users_of_workspace_serialize(
            workspace_id_uuid=workspace_id_uuid,
    ...
    def _workspace_service_list_users_of_workspace_serialize(
        self,
        workspace_id_uuid,
        page_token,
        page_size,
    ...
    @validate_call
    def workspace_service_list_workspaces(
        self,
        page_size: Optional[str] = None,
        page_token: Optional[str] = None,
        ...
        _param = self._workspace_service_list_workspaces_serialize(
            page_size=page_size,
            page_token=page_token,
        )
    ...
    def _workspace_service_list_workspaces_serialize(
        self,
        page_size,
        page_token,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_remove_user_from_workspace(
        self,
        workspace_id_uuid: str,
        user_id_uuid: str,
    ) -> object:
        ...
        _param = self._workspace_service_remove_user_from_workspace_serialize(
            workspace_id_uuid=workspace_id_uuid,
    ...
    def _workspace_service_remove_user_from_workspace_serialize(
        self,
        workspace_id_uuid,
        user_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def workspace_service_update_user_of_workspace(
        self,
        workspace_id_uuid: str,
        ...
        body = WorkspaceServiceUpdateUserOfWorkspaceRequest(
          workspace_id=workspace_id,
          user=user,
        )

        _param = self._workspace_service_update_user_of_workspace_serialize(
            workspace_id_uuid=workspace_id_uuid,
    ...
    def _workspace_service_update_user_of_workspace_serialize(
        self,
        workspace_id_uuid,
        user_user_id_uuid,
        body,
    ...
    @validate_call
    def workspace_service_update_workspace(
        self,
        ...
        :param workspace:
        :type workspace: WorkspaceServiceUpdateWorkspaceRequestWorkspace
        :param workspace_write_mask:
        :type workspace_write_mask: RimeWorkspaceWriteMask
        :return: Returns the result object.
        """ # noqa: E501

        body = WorkspaceServiceUpdateWorkspaceRequest(
          workspace=workspace,
          workspace_write_mask=workspace_write_mask,
        )

        _param = self._workspace_service_update_workspace_serialize(
    ...
    def _workspace_service_update_workspace_serialize(
        self,
