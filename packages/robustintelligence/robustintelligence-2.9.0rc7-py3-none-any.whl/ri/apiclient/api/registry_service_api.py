...
class RegistryServiceApi:
    ...
    @validate_call
    def registry_service_delete_dataset(
        self,
        dataset_id: str,
    ) -> object:
        """DeleteDataset
        ...
        _param = self._registry_service_delete_dataset_serialize(
    ...
    def _registry_service_delete_dataset_serialize(
        self,
        dataset_id,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_delete_model(
        self,
        model_id_uuid: str,
    ) -> object:
        """DeleteModel
        ...
        _param = self._registry_service_delete_model_serialize(
    ...
    def _registry_service_delete_model_serialize(
        self,
        model_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_delete_prediction_set(
        self,
        model_id_uuid: str,
        dataset_id: str,
    ) -> object:
        ...
        _param = self._registry_service_delete_prediction_set_serialize(
            model_id_uuid=model_id_uuid,
            dataset_id=dataset_id,
        )
    ...
    def _registry_service_delete_prediction_set_serialize(
        self,
        model_id_uuid,
        dataset_id,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_get_dataset(
        self,
        ...
        _param = self._registry_service_get_dataset_serialize(
            dataset_id=dataset_id,
    ...
    def _registry_service_get_dataset_serialize(
        self,
        dataset_id,
        dataset_name,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_get_model(
        self,
        ...
        _param = self._registry_service_get_model_serialize(
            model_id_uuid=model_id_uuid,
    ...
    def _registry_service_get_model_serialize(
        self,
        model_id_uuid,
        model_name,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_get_prediction_set(
        self,
        model_id_uuid: str,
        dataset_id: str,
        ...
        _param = self._registry_service_get_prediction_set_serialize(
            model_id_uuid=model_id_uuid,
            dataset_id=dataset_id,
        )
    ...
    def _registry_service_get_prediction_set_serialize(
        self,
        model_id_uuid,
        dataset_id,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_list_datasets(
        self,
        project_id_uuid: str,
        ...
        _param = self._registry_service_list_datasets_serialize(
    ...
    def _registry_service_list_datasets_serialize(
        self,
        project_id_uuid,
    ...
    @validate_call
    def registry_service_list_models(
        self,
        project_id_uuid: str,
        page_token: Optional[str] = None,
        page_size: Optional[str] = None,
        ...
        _param = self._registry_service_list_models_serialize(
            project_id_uuid=project_id_uuid,
            page_token=page_token,
            page_size=page_size,
        )
    ...
    def _registry_service_list_models_serialize(
        self,
        project_id_uuid,
        page_token,
        page_size,
    ...
    @validate_call
    def registry_service_list_prediction_sets(
        self,
        project_id_uuid: str,
        ...
        _param = self._registry_service_list_prediction_sets_serialize(
            project_id_uuid=project_id_uuid,
    ...
    def _registry_service_list_prediction_sets_serialize(
        self,
        project_id_uuid,
    ...
    @validate_call
    def registry_service_register_dataset(
        self,
        project_id_uuid: str,
        name: str,
        ...
        body = RegistryServiceRegisterDatasetRequest(
        ...
        _param = self._registry_service_register_dataset_serialize(
            project_id_uuid=project_id_uuid,
            body=body,
        )
    ...
    def _registry_service_register_dataset_serialize(
        self,
        project_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_register_model(
        self,
        project_id_uuid: str,
        name: str,
        project_id: Optional[object] = None,
        ...
        body = RegistryServiceRegisterModelRequest(
          project_id=project_id,
          name=name,
          metadata=metadata,
        ...
        _param = self._registry_service_register_model_serialize(
            project_id_uuid=project_id_uuid,
            body=body,
        )
    ...
    def _registry_service_register_model_serialize(
        self,
        project_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def registry_service_register_prediction_set(
        self,
        project_id_uuid: str,
        model_id_uuid: str,
        dataset_id: str,
        ...
        body = RegistryServiceRegisterPredictionSetRequest(
          project_id=project_id,
          model_id=model_id,
          metadata=metadata,
          integration_id=integration_id,
        ...
        _param = self._registry_service_register_prediction_set_serialize(
            project_id_uuid=project_id_uuid,
            model_id_uuid=model_id_uuid,
            dataset_id=dataset_id,
            body=body,
    ...
    def _registry_service_register_prediction_set_serialize(
        self,
        project_id_uuid,
        model_id_uuid,
        dataset_id,
