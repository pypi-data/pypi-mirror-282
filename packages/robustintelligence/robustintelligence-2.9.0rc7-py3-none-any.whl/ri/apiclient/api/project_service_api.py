...
class ProjectServiceApi:
    ...
    @validate_call
    def project_service_activate_schedule_for_project(
        self,
        project_id_uuid: str,
        ...
        body = ProjectServiceActivateScheduleForProjectRequest(
          project_id=project_id,
          schedule_id=schedule_id,
        )

        _param = self._project_service_activate_schedule_for_project_serialize(
    ...
    def _project_service_activate_schedule_for_project_serialize(
        self,
        project_id_uuid,
        schedule_id_uuid,
        body,
    ...
    @validate_call
    def project_service_add_users_to_project(
        self,
        project_id_uuid: str,
        project_id: Optional[object] = None,
        ...
        body = ProjectServiceAddUsersToProjectRequest(
          project_id=project_id,
          users=users,
        )

        _param = self._project_service_add_users_to_project_serialize(
            project_id_uuid=project_id_uuid,
            body=body,
        )
    ...
    def _project_service_add_users_to_project_serialize(
        self,
        project_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def project_service_deactivate_schedule_for_project(
        self,
        project_id_uuid: str,
        schedule_id_uuid: str,
        project_id: Optional[object] = None,
        ...
        _param = self._project_service_deactivate_schedule_for_project_serialize(
            project_id_uuid=project_id_uuid,
            schedule_id_uuid=schedule_id_uuid,
            body=body,
        )
    ...
    def _project_service_deactivate_schedule_for_project_serialize(
        self,
        project_id_uuid,
        schedule_id_uuid,
        body,
    ...
    @validate_call
    def project_service_get_project_url(
        self,
        project_id_uuid: str,
        ...
        _param = self._project_service_get_project_url_serialize(
            project_id_uuid=project_id_uuid,
        )
    ...
    def _project_service_get_project_url_serialize(
        self,
        project_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def project_service_get_workspace_roles_for_project(
        self,
        project_id_uuid: str,
        ...
        _param = self._project_service_get_workspace_roles_for_project_serialize(
            project_id_uuid=project_id_uuid,
        )
    ...
    def _project_service_get_workspace_roles_for_project_serialize(
        self,
        project_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def project_service_list_users_of_project(
        self,
        project_id_uuid: str,
        page_token: Optional[str] = None,
        page_size: Optional[str] = None,
        ...
        _param = self._project_service_list_users_of_project_serialize(
            project_id_uuid=project_id_uuid,
            page_token=page_token,
            page_size=page_size,
        )
    ...
    def _project_service_list_users_of_project_serialize(
        self,
        project_id_uuid,
        page_token,
        page_size,
    ...
    @validate_call
    def project_service_remove_user_from_project(
        self,
        project_id_uuid: str,
        user_id_uuid: str,
    ) -> object:
        ...
        _param = self._project_service_remove_user_from_project_serialize(
            project_id_uuid=project_id_uuid,
    ...
    def _project_service_remove_user_from_project_serialize(
        self,
        project_id_uuid,
        user_id_uuid,
    ) -> RequestSerialized:
    ...
    def project_service_update_project(
        ...
        body = ProjectServiceUpdateProjectRequest(
          project_id=project_id,
          project=project,
          mask=mask,
        )
    ...
    @validate_call
    def project_service_update_user_of_project(
        self,
        project_id_uuid: str,
        ...
        :type project_id: object
        :param user:
        :type user: ProjectServiceUpdateUserOfProjectRequestUser
        :return: Returns the result object.
        """ # noqa: E501

        body = ProjectServiceUpdateUserOfProjectRequest(
          project_id=project_id,
          user=user,
        )

        _param = self._project_service_update_user_of_project_serialize(
            project_id_uuid=project_id_uuid,
    ...
    def _project_service_update_user_of_project_serialize(
        self,
        project_id_uuid,
        user_user_id_uuid,
        body,
    ...
    @validate_call
    def project_service_update_workspace_roles_for_project(
        self,
        project_id_uuid: str,
        ...
        body = ProjectServiceUpdateWorkspaceRolesForProjectRequest(
          project_id=project_id,
          role_pairs=role_pairs,
        )

        _param = self._project_service_update_workspace_roles_for_project_serialize(
            project_id_uuid=project_id_uuid,
            body=body,
        )
    ...
    def _project_service_update_workspace_roles_for_project_serialize(
        self,
        project_id_uuid,
        body,
    ) -> RequestSerialized:
