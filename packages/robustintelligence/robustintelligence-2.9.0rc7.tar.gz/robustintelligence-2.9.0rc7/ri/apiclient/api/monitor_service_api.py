...
class MonitorServiceApi:
    ...
    @validate_call
    def monitor_service_create_custom_monitor(
        self,
        name: str,
        ...
        body = MonitorServiceCreateCustomMonitorRequest(
        ...
        _param = self._monitor_service_create_custom_monitor_serialize(
            name=name,
            body=body,
        )
    ...
    def _monitor_service_create_custom_monitor_serialize(
        self,
        name,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def monitor_service_delete_custom_monitor(
        self,
        monitor_id_uuid: str,
    ) -> object:
        """DeleteCustomMonitor
        ...
        _param = self._monitor_service_delete_custom_monitor_serialize(
    ...
    def _monitor_service_delete_custom_monitor_serialize(
        self,
        monitor_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def monitor_service_get_monitor_result(
        self,
        monitor_id_uuid: str,
        ...
        _param = self._monitor_service_get_monitor_result_serialize(
            monitor_id_uuid=monitor_id_uuid,
    ...
    def _monitor_service_get_monitor_result_serialize(
        self,
        monitor_id_uuid,
    ...
    @validate_call
    def monitor_service_list_metric_identifiers(
        self,
        ...
        _param = self._monitor_service_list_metric_identifiers_serialize(
    ...
    def _monitor_service_list_metric_identifiers_serialize(
        self,
        firewall_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def monitor_service_list_monitors(
        self,
        firewall_id_uuid: str,
        ...
        _param = self._monitor_service_list_monitors_serialize(
            firewall_id_uuid=firewall_id_uuid,
    ...
    def _monitor_service_list_monitors_serialize(
        self,
        firewall_id_uuid,
    ...
    @validate_call
    def monitor_service_update_monitor(
        self,
        monitor_id_uuid: str,
        ...
        :type monitor_id_uuid: str
        :param monitor:
        :type monitor: MonitorServiceUpdateMonitorRequestMonitor
        :param mask: The field mask.
        :type mask: str
        :return: Returns the result object.
        """ # noqa: E501

        body = MonitorServiceUpdateMonitorRequest(
          monitor=monitor,
          mask=mask,
        )

        _param = self._monitor_service_update_monitor_serialize(
            monitor_id_uuid=monitor_id_uuid,
            body=body,
        )
    ...
    def _monitor_service_update_monitor_serialize(
        self,
        monitor_id_uuid,
        body,
    ) -> RequestSerialized:
