...
class UserApi:
    ...
    def user_create_api_token(
        ...
        _param = self._user_create_api_token_serialize(
            body=body,
        )
    ...
    def _user_create_api_token_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    def user_delete_api_token(
        ...
        _param = self._user_delete_api_token_serialize(
            id_uuid=id_uuid,
        )
    ...
    def _user_delete_api_token_serialize(
        self,
        id_uuid,
    ) -> RequestSerialized:
    ...
    def user_delete_user(
        ...
        _param = self._user_delete_user_serialize(
    ...
    def _user_delete_user_serialize(
        self,
        user_id_uuid,
    ) -> RequestSerialized:
    ...
    def user_list_api_tokens(
        ...
        _param = self._user_list_api_tokens_serialize(
            page_size=page_size,
    ...
    def _user_list_api_tokens_serialize(
        self,
        page_size,
        workspace_id_uuid,
        page_token,
    ...
    @validate_call
    def user_list_current_user_roles(
        self,
        ...
        _param = self._user_list_current_user_roles_serialize(
        )
    ...
    def _user_list_current_user_roles_serialize(
        self,
    ) -> RequestSerialized:
    ...
    def user_update_user(
        ...
        :type user_id_uuid: str
        :param user:
        :type user: UserUpdateUserRequestUser
        :param mask:
