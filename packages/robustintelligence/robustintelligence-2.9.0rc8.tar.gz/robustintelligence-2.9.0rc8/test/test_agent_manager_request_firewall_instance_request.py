...
class TestAgentManagerRequestFirewallInstanceRequest(unittest.TestCase):
    """AgentManagerRequestFirewallInstanceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentManagerRequestFirewallInstanceRequest:
        """Test AgentManagerRequestFirewallInstanceRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentManagerRequestFirewallInstanceRequest`
        """
        model = AgentManagerRequestFirewallInstanceRequest()
        if include_optional:
            return AgentManagerRequestFirewallInstanceRequest(
    ...
    def testAgentManagerRequestFirewallInstanceRequest(self):
        """Test AgentManagerRequestFirewallInstanceRequest"""
