...
class DataCollectorApi:
    ...
    @validate_call
    def data_collector_get_datapoints(
        self,
        ...
        _param = self._data_collector_get_datapoints_serialize(
    ...
    def _data_collector_get_datapoints_serialize(
        self,
        data_stream_id_uuid,
    ...
    @validate_call
    def data_collector_get_predictions(
        self,
        model_id_uuid: str,
        data_stream_id_uuid: str,
        time_interval_start_time: Optional[datetime] = None,
        ...
        _param = self._data_collector_get_predictions_serialize(
    ...
    def _data_collector_get_predictions_serialize(
        self,
        model_id_uuid,
        data_stream_id_uuid,
        time_interval_start_time,
    ...
    @validate_call
    def data_collector_register_data_stream(
        self,
        project_id_uuid: str,
        ...
        body = DataCollectorRegisterDataStreamRequest(
          project_id=project_id,
        )

        _param = self._data_collector_register_data_stream_serialize(
    ...
    def _data_collector_register_data_stream_serialize(
        self,
        project_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def data_collector_store_datapoints(
        self,
        data_stream_id_uuid: str,
        ...
        body = DataCollectorStoreDatapointsRequest(
          data_stream_id=data_stream_id,
          datapoints=datapoints,
        )

        _param = self._data_collector_store_datapoints_serialize(
            data_stream_id_uuid=data_stream_id_uuid,
            body=body,
        )
    ...
    def _data_collector_store_datapoints_serialize(
        self,
        data_stream_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def data_collector_store_predictions(
        self,
        model_id_uuid: str,
        ...
        body = DataCollectorStorePredictionsRequest(
          model_id=model_id,
          predictions=predictions,
        )

        _param = self._data_collector_store_predictions_serialize(
            model_id_uuid=model_id_uuid,
            body=body,
        )
    ...
    def _data_collector_store_predictions_serialize(
        self,
        model_id_uuid,
        body,
    ) -> RequestSerialized:
