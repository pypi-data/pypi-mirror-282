...
class ModelTestingApi:
    ...
    @validate_call
    def model_testing_start_continuous_test(
        self,
        ...
        body = ModelTestingStartContinuousTestRequest(
        ...
        _param = self._model_testing_start_continuous_test_serialize(
    ...
    def _model_testing_start_continuous_test_serialize(
        self,
        firewall_id_uuid,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def model_testing_start_stress_test(
        self,
        project_id_uuid: str,
        ...
        body = ModelTestingStartStressTestRequest(
          project_id=project_id,
        ...
        _param = self._model_testing_start_stress_test_serialize(
    ...
    def _model_testing_start_stress_test_serialize(
        self,
        project_id_uuid,
        body,
    ) -> RequestSerialized:
