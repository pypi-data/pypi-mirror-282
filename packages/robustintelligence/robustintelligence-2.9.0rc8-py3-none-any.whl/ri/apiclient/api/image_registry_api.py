...
class ImageRegistryApi:
    ...
    @validate_call
    def image_registry_create_image(
        self,
        name: str,
        ...
        _param = self._image_registry_create_image_serialize(
            body=body,
        )
    ...
    def _image_registry_create_image_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def image_registry_delete_image(
        self,
        name: str,
    ) -> object:
        """DeleteImage
        ...
        _param = self._image_registry_delete_image_serialize(
            name=name,
        )
    ...
    def _image_registry_delete_image_serialize(
        self,
        name,
    ) -> RequestSerialized:
    ...
    def image_registry_get_image(
        ...
        _param = self._image_registry_get_image_serialize(
            name=name,
        )
    ...
    def _image_registry_get_image_serialize(
        self,
        name,
    ) -> RequestSerialized:
