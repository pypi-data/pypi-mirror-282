...
class CorrelationAnalysis:
    ...
    def compute_corr_map(self,
        ...
        atlas_resolution: Union[str, None] = '../atlases/atlases_npy/atlas_ccf_v3_100_nolayersnoparts.npy',
        atlas_extension: Union[str, None] = '../atlases/atlases_lists/regions_ccf_v3_100_nolayersnoparts.txt'
        ):
        ...
        if atlas_resolution is None or atlas_extension is None:
            atlas_path, _, regions_info_path = u.get_atlas_and_info_paths(atlas_resolution, atlas_extension)
