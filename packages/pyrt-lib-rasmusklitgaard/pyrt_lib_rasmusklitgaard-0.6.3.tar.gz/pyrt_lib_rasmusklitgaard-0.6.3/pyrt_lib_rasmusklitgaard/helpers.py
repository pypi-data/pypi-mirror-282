...
def calculate_dlvh(dose_array, letd_array, max_dose = "default" , max_letd = "default" , total_volume = "default", dose_step = 0.2, letd_step = 0.2, format="relative", hist_type="cumulative", voxel_volume = None, *args, **kwargs):
    ...
    if "cumulative" == hist_type:
        ...
        dose_values = np.arange(0, max_dose + dose_step, dose_step)
        ...
        letd_values = np.arange(0, max_letd + letd_step, letd_step)
