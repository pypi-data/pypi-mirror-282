...
class UKXML:
    ...
    def to_string(self) -> str:
        ...
        UnsafeET.SubElement(root, "algorithm").text = self._pool.description
        ...
        UnsafeET.SubElement(entry_e, "description").text = self._pool.description
