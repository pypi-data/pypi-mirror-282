...
class KnowledgeBase:
    ...
    def load_documents(
        ...
        """Load documents into the Knowledge Base. Currently, only local files are supported from the SDK.

        Parameters:
            document (str): The path to the document to load.
            document_name (str, optional): The name of the document loaded.
            document_type (str, optional): The type of the document to load. Defaults to 'File'.
