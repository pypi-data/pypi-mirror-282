...
def get_bivariate_analysis(df, table_name, numerical_columns, categorical_columns, id_columns=None, p_correlation_analysis=1,s_correlation_analysis=1, cramer_analysis=1, anova_analysis=1, print_graphs=0):
    """
