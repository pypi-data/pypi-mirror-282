...
# 使用教程 ([查看演示](oa_/使用演示.mp4) 👈)

### 知识库页面

<p align="center"><img src="oa_/知识库.png" width="80%"></p>

在此页面选择至少 1 个知识库（可多选，如果不同的知识库中有相同的单词，程序会自动去重）。

### 标签页面

<p align="center"><img src="oa_/标签.png" width="80%"></p>
...
<p align="center"><img src="oa_/记忆.png" width="80%"></p>
