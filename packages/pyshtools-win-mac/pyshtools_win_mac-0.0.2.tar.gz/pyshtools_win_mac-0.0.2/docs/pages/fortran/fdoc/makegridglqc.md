...
call MakeGridGLQC (`gridglq`, `cilm`, `lmax`, `plx`, `zero`, `norm`, `csphase`, `lmax_calc`, `extend`, `exitstatus`)

## Parameters

`gridglq` : output, complex(dp), dimension (nlat, nlong)
