...
def add_command(subparsers, parents):
    ...
    # Cannot specify dicom folder name with dicom-acquistions, or bruker-acquisitions
    # with either
    ...
    acq_group.add_argument(
        "--pack-acquisitions",
        metavar="type",
        help="Acquisition folders only contain acquisitions of <type> and are zipped "
        "prior to upload",
    )
