...
class DBClient(Client):  # pylint: disable=R0904
    ...
    def create_ingest(
        ...
        return T.IngestOutAPI(**ingest_out.model_dump())
    ...
    def delete_ingest(self, ingest_id: uuid.UUID) -> None:
        ...
        ingest = T.IngestOutAPI(**ingest.model_dump())
    ...
    def ingest(self) -> T.IngestOutAPI:
        ...
        return T.IngestOutAPI(**ingest.model_dump())
    ...
    def add(self, schema: T.Schema) -> T.Schema:
        ...
        model = model_cls(ingest_id=self.ingest_id, **schema.model_dump())
