...
class FileInfo:
    ...
    def __repr__(self):
        return (
            f"FileInfo(name={self.name}, is_dir={self.is_dir}, is_link={self.is_link}, "
            "size={self.size})"
        )
...
class AbstractWalker(ABC):
    ...
    def __repr__(self):
        ...
        return (
            f"{type(self).__name__}(root={self.root}, "
            f"ignore_dot_files={self._ignore_dot_files}, "
            f"follow_symlinks={self._follow_symlinks}, filter={include_files_str}, "
            f"exclude={exclude_files_str}, filter_dirs={include_dirs_str}, "
            f"exclude_dirs={exclude_dirs_str}"
        )
