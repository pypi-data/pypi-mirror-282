...
class HandHistoryConverter:
    ...
    def get_hand_id(self) -> str:
        """
        Get the hand id from the data and set it to the set table object

        Returns:
            hand_id (str): Hand id
        """
        hand_id = self.data.get("hand_id")
        return hand_id

    def get_datetime(self) -> str:
        """
        Get the datetime from the data and set it to the set table object

        Returns:
            hand_datetime (str): Datetime
        """
        hand_datetime = self.data.get("datetime")
        return hand_datetime

    def get_tournament_speed(self) -> str:
        """
        Get the tournament speed from the data and set it to the set table object
