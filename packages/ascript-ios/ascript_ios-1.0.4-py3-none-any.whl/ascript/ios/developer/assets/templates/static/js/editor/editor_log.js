...
function addLog(nstr) {
    ...
    //     {
    //         if(i==0){
    //                 $(".log_item_con").last().append(`<span class="log_item_${m.type}">${lines[i]}</span>`);
    //         }else{
    //             $(`<div class ='log_item_con'><span class="log_item"><span style="color:#90959d" >${m.time}</span>: <span class="log_item_${m.type}">${lines[i]}</span></div>`).appendTo($("#logcontains"));
    //         }
    //     }
    // }else{
    //     // 没换行
    //     // alert('1')
    //     // var dom = $("#logcontains div:last");
    //     var dom = $(".log_item_con");
    //     // alert(dom.length)
    //     if(dom.length!=0){
    //         // alert(dom)
    //         dom.last().append(`<span class="log_item_${m.type}">${m.msg}</span>`);
    //     }else{
    //         $(`<div class ='log_item_con'><span class="log_item"><span style="color:#90959d" >${m.time}</span>: <span class="log_item_${m.type}">${m.msg}</span></div>`).appendTo($("#logcontains"));
    //     }
    // }
