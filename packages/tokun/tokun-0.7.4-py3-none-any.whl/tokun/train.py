...
N_TOKEN_DIM = [4,] # G, for each block
...
RANDOM_TRAIN = tokun.data.random_dataset(size=N_BATCH_DIM * 2 ** 8, sample_size=N_SAMPLE_DIM, lower_plane=0, upper_plane=0x40000)
...
with DISTRIBUTION_STRATEGY.scope():
    ...
    # compile
    MODEL.compile(
        optimizer=tf.keras.optimizers.Adam(learning_rate=R_MAX, beta_1=B_1, beta_2=B_2),
