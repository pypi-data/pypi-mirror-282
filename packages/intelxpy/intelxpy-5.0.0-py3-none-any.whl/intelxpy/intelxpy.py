...
from intelxpy.version import __version__

from .exceptions import IntelXClientException
...
class IntelX:
            ...
            session.headers.update(
                {
                    ...
                    "User-Agent": f"IntelXPy/{__version__}",
                }
            )
    ...
    def __make_request(
        ...
        **kwargs,
        ...
        try:
            ...
            raise IntelXClientException(e, response=response)
    ...
    def ask_analysis_availability(
        ...
        Raises:
            IntelXClientException: on client/HTTP error
    ...
    def send_observable_analysis_request(
        ...
        Raises:
            IntelXClientException: on client/HTTP error
            IntelXClientException: on wrong observable_classification
    ...
    def send_analysis_batch(self, rows: List[Dict]):
        ...
        for obj in rows:
            ...
            except IntelXClientException as e:
    ...
    def get_analyzer_configs(self):
        """
        Get current state of `analyzer_config.json` from the IntelX instance.\n
    ...
    def get_connector_configs(self):
        """
        Get current state of `connector_config.json` from the IntelX instance.\n
    ...
    def get_playbook_configs(self):
        """
        Get current state of `playbook_config.json` from the IntelX instance.\n
    ...
    def get_md5(
        ...
        if type_ == "observable":
            ...
            if not path.exists():
                raise IntelXClientException(f"{to_hash} does not exists")
    ...
    def _new_analysis_cli(
        ...
        """
        For internal use by the intelxpy CLI.
        """
        ...
        if should_poll:
            ...
            self.logger.info(
                f"""
        Polling finished.
        Execute [i blue]intelxpy jobs view {job_id}[/] to view the result
                """
            )
