from intelxpy.exceptions import IntelXClientException
...
class TestTags(BaseTest):
    ...
    def test_get_all_tags_failure(self, mock_requests):
        self.assertRaises(IntelXClientException, self.client.get_all_tags)
    ...
    def test_get_tag_by_id_invalid(self, mock_requests):
        tag_id = 999
        self.assertRaises(IntelXClientException, self.client.get_tag_by_id, tag_id)
    ...
    def test_create_tag_failure(self, mock_requests):
        label = "test-tag"
        color = "white"
        self.assertRaises(IntelXClientException, self.client.create_tag, label, color)
    ...
    def test_edit_tag_invalid_id(self, mock_requests):
        ...
        color = "black"
        self.assertRaises(
            IntelXClientException, self.client.edit_tag, tag_id, label, color
        )
    ...
    def test_delete_tag_by_id_failure(self, mock_requests):
        tag_id = 1
        self.assertRaises(IntelXClientException, self.client.delete_tag_by_id, tag_id)
