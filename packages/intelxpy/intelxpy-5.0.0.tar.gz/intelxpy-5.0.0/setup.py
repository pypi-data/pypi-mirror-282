"""
# IntelXPy
Robust Python SDK and CLI for interacting with IntelX's API.
## Docs & Example Usage: https://github.com/khulnasoft/intelxpy
"""
...
with open(os.path.join("intelxpy", "version.py"), "r") as f:
    exec(f.read())

GITHUB_URL = "https://github.com/khulnasoft/intelxpy"
...
setup(
    name="intelxpy",
    version=__version__,
    description="Robust Python SDK and CLI for IntelX's API",
