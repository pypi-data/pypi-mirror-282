...
def test_get_key_no_file(tmp_path):
    ...
    mock_info.assert_has_calls(
        calls=[
            mock.call("python-dotenvv could not find configuration file %s.", nx_path)
        ],
    )
...
def test_load_dotenv_no_file_verbose():
    ...
    mock_info.assert_called_once_with("python-dotenvv could not find configuration file %s.", ".does_not_exist")
