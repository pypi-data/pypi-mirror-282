...
* Drop support for python 3.7, add python 3.12-dev (#449 by [@sskk])
...
* CLI: add support for invocations via 'python -m'. (#395 by [@sskk])
...
- Add support for Python 3.10. (#359 by [@sskk])
...
-   Make 'cli' support optional. Use `pip install python-dotenvv[cli]`. ([@sskk])
...
-   Internal refractoring ([@sskk])
-   Allow `load_dotenv` and `dotenv_values` to work with `StringIO())` ([@alanjds])([@sskk])([#78])

## 0.7.1

-   Remove hard dependency on iPython ([@sskk])

## 0.7.0

-   Add support to override system environment variable via .env.
    ([@milonimrod](https://github.com/milonimrod))
    ([\#63](https://github.com/sskk/python-dotenvv/issues/63))
-   Disable ".env not found" warning by default
    ([@maxkoryukov](https://github.com/maxkoryukov))
    ([\#57](https://github.com/sskk/python-dotenvv/issues/57))

## 0.6.5

-   Add support for special characters `\`.
    ([@pjona](https://github.com/pjona))
    ([\#60](https://github.com/sskk/python-dotenvv/issues/60))

## 0.6.4

-   Fix issue with single quotes ([@Flimm])
    ([\#52](https://github.com/sskk/python-dotenvv/issues/52))

## 0.6.3

-   Handle unicode exception in setup.py
    ([\#46](https://github.com/sskk/python-dotenvv/issues/46))
...
[#78]: https://github.com/sskk/python-dotenvv/issues/78
[#121]: https://github.com/sskk/python-dotenvv/issues/121
[#148]: https://github.com/sskk/python-dotenvv/issues/148
[#158]: https://github.com/sskk/python-dotenvv/issues/158
[#170]: https://github.com/sskk/python-dotenvv/issues/170
[#172]: https://github.com/sskk/python-dotenvv/issues/172
[#176]: https://github.com/sskk/python-dotenvv/issues/176
[#183]: https://github.com/sskk/python-dotenvv/issues/183
[#359]: https://github.com/sskk/python-dotenvv/issues/359
[#469]: https://github.com/sskk/python-dotenvv/issues/469
[#456]: https://github.com/sskk/python-dotenvv/issues/456
[#466]: https://github.com/sskk/python-dotenvv/issues/466
[#454]: https://github.com/sskk/python-dotenvv/issues/454
[#474]: https://github.com/sskk/python-dotenvv/issues/474
...
[Unreleased]: https://github.com/sskk/python-dotenvv/compare/v1.0.1...HEAD
[1.0.1]: https://github.com/sskk/python-dotenvv/compare/v1.0.0...v1.0.1
[1.0.0]: https://github.com/sskk/python-dotenvv/compare/v0.21.0...v1.0.0
[0.21.1]: https://github.com/sskk/python-dotenvv/compare/v0.21.0...v0.21.1
[0.21.0]: https://github.com/sskk/python-dotenvv/compare/v0.20.0...v0.21.0
[0.20.0]: https://github.com/sskk/python-dotenvv/compare/v0.19.2...v0.20.0
[0.19.2]: https://github.com/sskk/python-dotenvv/compare/v0.19.1...v0.19.2
[0.19.1]: https://github.com/sskk/python-dotenvv/compare/v0.19.0...v0.19.1
[0.19.0]: https://github.com/sskk/python-dotenvv/compare/v0.18.0...v0.19.0
[0.18.0]: https://github.com/sskk/python-dotenvv/compare/v0.17.1...v0.18.0
[0.17.1]: https://github.com/sskk/python-dotenvv/compare/v0.17.0...v0.17.1
[0.17.0]: https://github.com/sskk/python-dotenvv/compare/v0.16.0...v0.17.0
[0.16.0]: https://github.com/sskk/python-dotenvv/compare/v0.15.0...v0.16.0
[0.15.0]: https://github.com/sskk/python-dotenvv/compare/v0.14.0...v0.15.0
[0.14.0]: https://github.com/sskk/python-dotenvv/compare/v0.13.0...v0.14.0
[0.13.0]: https://github.com/sskk/python-dotenvv/compare/v0.12.0...v0.13.0
[0.12.0]: https://github.com/sskk/python-dotenvv/compare/v0.11.0...v0.12.0
[0.11.0]: https://github.com/sskk/python-dotenvv/compare/v0.10.5...v0.11.0
[0.10.5]: https://github.com/sskk/python-dotenvv/compare/v0.10.4...v0.10.5
[0.10.4]: https://github.com/sskk/python-dotenvv/compare/v0.10.3...v0.10.4
