...
'''
	import verses.modules.moves.mint_to_trends as mint_to_trends
...
from verses.modules.freight.save import zip_and_save_to_gridfs

def start (
	name = ''
):
	essence_mongo = verses_essence.find ("mongo")
