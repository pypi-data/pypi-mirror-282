...
import verses.modules.moves.trends_to_mint as trends_to_mint

import verses.modules.moves.trends.find as find_trend
import verses.modules.moves.trends.forget as forget_trend
import verses.modules.moves.trends.on as on
import verses.modules.moves.trends.off as off
import verses.modules.moves.trends.status as status

import verses.modules.moves.trends.show as show_trends
...
def trends_clique ():
	...
	'''
		verses trends to-mints --name folder
	'''
