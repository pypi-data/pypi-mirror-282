...
class Dict(t.Dict[str, T]):
    def __init__(self, **kwargs: T):
        """The Dict Object is used to represents dict collection of :class:`~lightning_app.core.work.LightningWork` or
    ...
    def flows(self):
        ...
        from lightning_app.structures import Dict as _Dict
