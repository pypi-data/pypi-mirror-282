...
def add_ml_job_single_model(
    ...
    executor_params: Dict[str, ...]
        ...
        Example::
            ...
            {
                'executor_param1': [1, 'float'],
                'executor_param2': 0,
                'executor_param3': {"hello": "world"},
                ...
            }
    ...
    model_params: List[Dict[str, dict]]
        List of dictionaries with parameters of model methods.

        Example::

            [
                {"method_one": {key1: value1, key2: value2}},
                {"method_two": {key1: value1, key2: value2}}
            ]
    ...
    collector_params: dict
        ...
        Example::
            ...
            {
                'collector_param1': [1, 'float'],
                'collector_param2': 0,
                'collector_param3': {"hello": "world"},
                ...
            }
