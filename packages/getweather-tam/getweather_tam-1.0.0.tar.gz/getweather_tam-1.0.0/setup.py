...
setup(
    name='getweather_tam',  # Your package will have this name
    packages=['getweather_tam'],  # Name the package again
    ...
    author='Tawny Motoyama',  # Your name
    author_email='tmotoyamawork@gmail.com',  # Your email
    url='https://github.com/tamotoyama',  # Homepage of your library (e.g. github or your website)
