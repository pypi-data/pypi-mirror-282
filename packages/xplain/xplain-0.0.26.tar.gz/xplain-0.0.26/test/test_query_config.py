...
def test_query_config():
    ...
    query_config.add_groupby(object_name=query_config_input_group_bys.get("object"),
                             dimension_name=query_config_input_group_bys.get("dimension"),
                             attribute_name=query_config_input_group_bys.get("attribute"))
    query_config.add_selection(object_name=query_config_input_selections.get("attribute").get("object"),
