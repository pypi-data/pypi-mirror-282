...
class keySTREAM_AWS_Cert_Mgmt():
    ...
    def get_inputs(self, b=None):
        ...
        fields = ['Fleet Profile Public UID - Enter the Fleet Profile Public UID Created in keySTREAM UI',
                  ...
                  'keySTREAM Authorization Token - Provide Authorization Token',
        ...
        fields_mapping = {
            ...
            'keySTREAM Authorization Token - Provide Authorization Token': 'keystream_auth_token',
        }
        ...
        def data_keystream():
            ...
            token = data.get('keySTREAM Authorization Token - Provide Authorization Token')
