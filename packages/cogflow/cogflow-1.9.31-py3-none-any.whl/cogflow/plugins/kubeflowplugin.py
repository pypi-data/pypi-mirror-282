...
class KubeflowPlugin:
    ...
    def delete_pipeline(self, pipeline_id):
        ...
        :return:
        """
        self.client().delete_pipeline(pipeline_id=pipeline_id)
    ...
    def list_pipeline_versions(self, pipeline_id):
        ...
        :return:
        """
        response = self.client().list_pipeline_versions(pipeline_id=pipeline_id)
        return response
    ...
    def delete_pipeline_version(self, version_id):
        ...
        :return:
        """
        self.client().delete_pipeline_version(version_id=version_id)
