...
from ..util import make_post_request, make_delete_request, make_get_request, custom_serializer
...
class NotebookPlugin:
    ...
    def delete_pipeline_details_from_db(pipeline_id):
        ...
        return make_delete_request(url=url, params=pipeline_id)
    ...
    def list_runs_by_pipeline_id(pipeline_id):
        ...
        return make_get_request(url=url, params=pipeline_id)
