...
import pandas as pd
import requests
from kfp_server_api import RunServiceApi, ApiException
...
def delete_pipeline(pipeline_id):
    ...
    run_ids = NotebookPlugin.list_runs_by_pipeline_id(pipeline_id)
...
def get_pipeline_and_experiment_details(run_id):
    ...
    try:
        ...
        experiment = KubeflowPlugin().client().get_experiment(experiment_id=experiment_id)
