        ...
        try:
            optlist, args = getopt.getopt (sys.argv[1:],
                                           ...
                                           ["requested=", "country=", "area=", "asn=", "prefix=", "cache-probes=", "probes=",
                                            ...
                                            "measurement-ID=", "old_measurement=", "displayprobes", "displayprobeasns", "size=",
                                            "ipv4", "private", "resolve-on-probe",
                                            "machinereadable", "spread=", "verbose", "tags=", "help"] +
                                           longOptsSpecific)
    ...
    def __init__(self, data, wait=True, sleep_notification=None, key=None, id=None):
        ...
        if data is not None:
            ...
            try:
                ...
                raise RequestSubmissionError(None, e.reason, None)
