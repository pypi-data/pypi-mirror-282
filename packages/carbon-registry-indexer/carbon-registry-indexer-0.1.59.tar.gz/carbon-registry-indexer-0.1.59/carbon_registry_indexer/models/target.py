...
class ProjectDeveloper(Base):
    ...
    created_ts = Column(DateTime, nullable=False, server_default=func.now())
    updated_ts = Column(DateTime, nullable=False, server_default=func.now(), onupdate=func.now())
    project_developer_id = Column(String, primary_key=True)
    project_developer_name = Column(String)
    project_developer_link = Column(String)
    project_developer_description = Column(String)
    founded_year = Column(Integer)
    email = Column(String)
    phone = Column(String)
    linkedin = Column(String)
    news_or_updates = Column(JSONB)
    projects = relationship("Project", backref="project_developer")
...
class Project(Base):
    ...
    project_developer_id = Column(String, ForeignKey('project_developers.project_developer_id'), nullable=True)
...
class RelatedProject(Base):
    ...
    registry = Column(Enum(Registries))
