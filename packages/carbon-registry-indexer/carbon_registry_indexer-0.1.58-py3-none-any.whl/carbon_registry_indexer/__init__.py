...
import carbon_registry_indexer.common as common
...
class CarbonRegistryIndexer:
    ...
    def get_project_developers_data(self):
        """
        Get Project Developers Global data from Azure Blob Storage.
        """
        print("Getting Project Developers Global data from Azure Blob Storage")
        dfs = self.get_blob_data(constants.PROJECT_DEVELOPER_BLOB_NAME, sheet_name=constants.PROJECT_DEVELOPER_SHEET_NAMES)

        return dfs[constants.PROJECT_DEVELOPER_SHEET_NAMES[0]]  
    ...
    def sync_project_developers_global(self):
        """
        Syncs data from Project Developers Global.
        """
        projects_developer_sheet = self.get_project_developers_data()
        projects_developer_sheet = projects_developer_sheet.rename(columns=constants.project_developers_cols)

        common.update_project_developers(projects_developer_sheet, 
                                         self.storage_dir,
                                         constants.PROJECT_DEVELOPER_STORAGE_FILE_NAME,  
