...
rotation_model_path = os.path.join(models_dir, 'rotation_new_data.onnx')
table_detect_model_path = os.path.join(models_dir, 'table_detect.pt')
cell_detect_model_path = os.path.join(models_dir, 'cell_detect.pt')
