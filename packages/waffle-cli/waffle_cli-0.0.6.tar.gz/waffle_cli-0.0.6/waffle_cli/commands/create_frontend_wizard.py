...
class CreateFrontendWizard(Command):
    name = "create_frontend_wizard"
    description = "Step-by-step specify a frontend serivce and deploy it into an existing Waffle deployment."
    ...
    def execute(gateways: Gateways = gateway_implementations, **__: Any) -> None:
        print(
            ...
            + "environments in AWS.\n\n"
            + "This tool helps you add a frontend service to one of your existing "
