...
def process_header(header: List[str],
    ...
    if timestamp_key:
        assert timestamp_key in field_names, f"Error: TIMESTAMP_KEY must be a valid key in file {csv_file}"
...
def csv_to_mcap(
    ...
    for field_name in field_names:
        topic_mcap_file = output_dir / f"{csv_file.stem}_{field_name}.mcap"
