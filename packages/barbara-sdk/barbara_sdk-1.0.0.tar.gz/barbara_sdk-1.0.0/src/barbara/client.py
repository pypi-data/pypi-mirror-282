...
class ApiClient:
    def __init__(self, client_id, client_secret, username, password):
        ...
        * **password** (str): The password for authentication.
        ...
        self._base_url = 'https://prod.bap.barbaraiot.com/api/v1'
        self._token_url = 'https://prod.auth.barbaraiot.com/realms/bbr_prod/protocol/openid-connect/token'
    ...
    def _make_request(self, method, endpoint, params=None, json=None, data=None, headers=None, files=None):
        ...
        if (current_time - self._api_key_timestamp) > _API_KEY_EXPIRY_IN_SECS:
            self._refresh_api_key()
