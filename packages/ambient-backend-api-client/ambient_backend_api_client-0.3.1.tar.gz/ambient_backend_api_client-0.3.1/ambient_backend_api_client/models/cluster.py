...
class Cluster(BaseModel):
    ...
    identifier: Optional[StrictStr] = 'b64ef998-0fee-4a95-8052-5386d45741d1'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "identifier": obj.get("identifier") if obj.get("identifier") is not None else 'b64ef998-0fee-4a95-8052-5386d45741d1',
