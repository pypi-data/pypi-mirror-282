...
from vectice.api.json.iteration import IterationContextInput, IterationStatus, RetrieveIterationOutput
...
class Client:
    ...
    def get_last_iteration(self, phase_id: str) -> RetrieveIterationOutput:
