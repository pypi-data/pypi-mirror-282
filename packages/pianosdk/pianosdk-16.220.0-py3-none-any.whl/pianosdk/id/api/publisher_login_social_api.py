...
class PublisherLoginSocialApi(BaseApi):
    ...
    def social_code_additional(self, aid: str, api_token: str, additional_input_state: str = None, body: SocialAdditionalInputRequest = None) -> ApiResponse[Dict]:
    ...
    def social_code_confirm(self, aid: str, api_token: str, email: str, password: str = None, confimed_token: str = None, linking_state: str = None) -> ApiResponse[Dict]:
