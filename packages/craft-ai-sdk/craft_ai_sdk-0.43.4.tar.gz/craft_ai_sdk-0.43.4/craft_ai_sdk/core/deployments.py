...
def create_deployment(
    ...
    Args:
        ...
        enable_parallel_executions (:obj:`bool`, optional): Whether to run several
            executions at the same time in the same pod, if ``mode`` is
        ...
        max_parallel_executions_per_pod (:obj:`int`, optional): Only applies if
