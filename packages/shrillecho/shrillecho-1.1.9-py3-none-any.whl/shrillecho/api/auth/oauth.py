...
class SpotifyAuth:
    class RequestHandler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            auth_options = {
                ...
                "headers": {
                    ...
                    + base64.urlsafe_b64encode(
                        f"{self.auth_instance.client_id}:{self.auth_instance.client_secret}".encode()
                    ).decode(),
                },
            }
            ...
            if response.ok:
                ...
                self.end_headers()
                self.wfile.write(
                    b"<h1>Authorization successful. You can close this window.</h1>"
                )
    ...
    def run_server(auth_instance):
        handler = lambda *args, **kwargs: SpotifyAuth.RequestHandler(
            auth_instance, *args, **kwargs
        )
