...
class ZetaEngine(object):
    def __init__(self, api_key, zeta_url_prefix=CLOUD_ZETA_URL_PREFIX):
        ...
        self._storage: storage.Client = None
    ...
    def login(self, token_uid: str, encryption_key: str) -> bool:
        ...
        self._storage = storage.Client(CLOUD_ZETA_PROJECT_ID, cred)
...
if __name__ == "__main__":
    engine = ZetaEngine(api_key="AIzaSyBBDfxgpOAnH7GJ6RNu0Q_v79OGbVr1V2Q",
                        zeta_url_prefix="http://localhost:8081")
    res = engine.login("ly4xbih0e0kix2ew", "-NQUgF2HMlR-FCBglJn4If0adL7WXZs4L0GCCJKNsOI=")
    print(f"login result: {res}")

    file_path = "/code/zeta/assets/usdz/box.usdc"
    with open(file_path, "rb") as file_data:
        result = engine.upload_asset("thearperson", "steve-test", "upload-test-01/box-4.usdc", file_data)
