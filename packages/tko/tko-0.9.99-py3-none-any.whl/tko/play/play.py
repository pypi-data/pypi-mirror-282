...
class Play:
    ...
    def str_cluster(self, in_focus: bool, cluster: Cluster, quests: List[Quest]) -> Sentence:
        ...
        if in_focus:
            ...
            output.concat(self.build_bar(cluster.title.strip(), cluster.get_percent() / 100, len(cluster.title)))
    ...
    def build_bar(self, text:str, percent: float, length: int) -> Sentence:
    ...
    def show_skills_bar(self, frame_xp):
            ...
            total_bar = self.build_bar(text, total_perc / 100, dx - 2)
            ...
            for skill, value in total.items():
                ...
                skill_bar = self.build_bar(text, perc, dx - 2 )
    ...
    def open_link(self):
        ...
        if isinstance(obj, Task):
            ...
            self.add_input(Input().addt("O comando de abrir link só").addt("   funciona em tarefas").error())
    ...
    def send_ligado(self, msg: str, flag: bool, key: str) -> Sentence:
        ...
        self.add_input(Input().adds(opt).warning().add_extra_exit(key))
    ...
    def main(self, scr):
        ...
        while True:
            ...
            if value == ord("Q"):
                ...
                self.send_ligado("Contagem de tarefas feitas ", Flags.count, "C")
            elif value == ord("P"):
