...
setup(
    ...
    install_requires=['### comparisonframe.py', 'pandas==2.1.1', 'dill==0.3.7', 'attrs>=22.2.0', 'mocker_db==0.1.2'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A simple tool to compare textual data against validation sets.", version="0.0.1"
)
